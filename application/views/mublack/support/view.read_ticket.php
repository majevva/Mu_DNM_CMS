                            ...
                            <div class="entry">
                                ...
                                <table class="ticket right" style="width:200px;" cellspacing="0">
                                    ...
                                    <?php if($ticket_data['status'] != 3){ ?>
                                        <tr id="tr_resolved">
                                            <td colspan="2" style="text-align:center;"><a href="" id="mark_resolved" data-id="<?php echo $ticket_data['id']; ?>"><?php echo __('Mark As Resolved'); ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <?php
                                        ...
                                        $(document).ready(function () {
                                            $('#mark_resolved').on('click', function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    data: {id: $('#mark_resolved').attr("data-id"), dmn_csrf_protection: DmNConfig.dmn_csrf_token},
                                                    beforeSend: function () {
                                                        App.showLoader();
                                                    },
                                                    complete: function () {
                                ...
                                <?php if($ticket_data['status'] != 1 && $ticket_data['status'] != 3 && $ticket_data['status'] != 4){ ?>
                                    <form method="post" action="" id="support_reply_form">
                                        ...
                                        <div style="text-align:center;"><textarea name="text" id="ticket_reply"></textarea></div>
