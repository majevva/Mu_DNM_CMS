	 ...
	 <div class="row-fluid">
        <div class="span12">
            <p class="left">
                ...
                <a href="<?php echo $this->config->base_url; ?>admincp/change-class-allowed-class-list" class="btn btn-large btn-primary">Class List</a>
            </p>
						...
						<div class="control-group">
                            ...
                            <div class="controls">
                                <select id="active" name="active">
                                    <option value="0" <?php if (isset($changeclass_config['skill_tree']['active']) && $changeclass_config['skill_tree']['active'] == 0) {echo 'selected="selected"';} ?>>No
                                    </option>
                                    <option value="1" <?php if (isset($changeclass_config['skill_tree']['active']) && $changeclass_config['skill_tree']['active'] == 1) {echo 'selected="selected"';} ?>>Yes
                                    </option>
                                </select>
