...
<div id="content">
    <div id="box1">
        <div class="title1">
            <h1><?php echo _('Recover MasterLevel'); ?></h1>
        </div>
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('Recover your character master level and class'); ?></h2>
                            ...
                            <form method="post" action="">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="submit"
                                                    class="btn-enter auth"><?php echo _('Recover'); ?></button>
                                        </td>
                                    </tr>
                                </table>
                            </form>
