                ...
                <form class="form-horizontal" method="POST" action="" id="email_settings_form">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span6 typeahead" id="smtp_port" name="smtp_port"
                                       value="<?php echo (isset($email_config['smtp_port'])) ? $email_config['smtp_port'] : ''; ?>" placeholder="25"/>
                            </div>
                        </div>
                        <div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
							  <label class="radio">
								<input type="checkbox" id="welcome_email" name="welcome_email" value="1" <?php if (isset($email_config['welcome_email']) && $email_config['welcome_email'] == 1) {
						...
						<div class="control-group">
							...
							<div class="controls">
							  <label class="radio">
								<input type="checkbox" id="vip_purchase_email" name="vip_purchase_email" value="1" <?php if (isset($email_config['vip_purchase_email']) && $email_config['vip_purchase_email'] == 1) {
                                        echo 'checked="checked"';
                                    } ?> data-no-uniform="true">  Notify user by E-Mail when vip has been purchased successfully
							  </label>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
							  <label class="radio">
								<input type="checkbox" id="donate_email_user" name="donate_email_user" value="1" <?php if (isset($email_config['donate_email_user']) && $email_config['donate_email_user'] == 1) {
                                        echo 'checked="checked"';
                                    } ?> data-no-uniform="true">  Notify user by E-Mail when donation has been successfull
							  </label>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
							  <label class="radio">
								<input type="checkbox" id="donate_email_admin" name="donate_email_admin" value="1" <?php if (isset($email_config['donate_email_admin']) && $email_config['donate_email_admin'] == 1) {
                                        echo 'checked="checked"';
						...
						<div class="control-group">
							...
							<div class="controls">
							  <label class="radio">
								<input type="checkbox" id="support_email_user" name="support_email_user" value="1" <?php if (isset($email_config['support_email_user']) && $email_config['support_email_user'] == 1) {
                                        echo 'checked="checked"';
                                    } ?> data-no-uniform="true">  Notify user by E-Mail when administrator have answered or replied to support ticket
							  </label>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
							  <label class="radio">
								<input type="checkbox" id="support_email_admin" name="support_email_admin" value="1" <?php if (isset($email_config['support_email_admin']) && $email_config['support_email_admin'] == 1) {
                                        echo 'checked="checked"';
                                    } ?> data-no-uniform="true">  Notify admin by E-Mail when user have created or replied to support ticket
							  </label>
							</div>
						</div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" name="edit_email_settings" id="edit_email_settings">Save changes</button>
