            ...
            <div id="content_center">
                ...
                if (!empty($guide)):
                    ...
                    <div class="box-style1" style="margin-bottom:25px;">
                        <div class="entry">
                            <div style="width:500px;word-wrap: break-word;"><?php echo str_replace("\0", "", str_replace('Â', '&nbsp;', $guide['text'])); ?></div>
                            <div class="meta-bg">
                                <div class="meta">
                                    <p class="tags"><?php echo _('Posted'); ?> <?php echo date('d / m / Y', strtotime($guide['date'])); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
