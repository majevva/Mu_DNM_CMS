                                ...
                                <form method="post" action="" id="change_lost_password" name="change_lost_password">
                                    <table>
                                        <tr>
                                            ...
                                            <td><input
                                                    class="validate[required,minSize[<?php echo $rconfig['min_password']; ?>],maxSize[<?php echo $rconfig['max_password']; ?>]]"
                                        ...
                                        <tr>
                                            ...
                                            <td><input
                                                    class="validate[required,minSize[<?php echo $rconfig['min_password']; ?>],maxSize[<?php echo $rconfig['max_password']; ?>],equals[new_password]]"
