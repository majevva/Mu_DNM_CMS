            ...
            <div class="box-content">
                <form class="form-horizontal" method="POST" action="" id="add_event_timer">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="days" name="days[]" multiple data-rel="chosen" required>
                                <option value="0" <?php if (isset($_POST['days']) && in_array(0, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Every Day</option>
                                <option value="1" <?php if (isset($_POST['days']) && in_array(1, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Monday</option>
                                <option value="2" <?php if (isset($_POST['days']) && in_array(2, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Tuesday</option>
                                <option value="3" <?php if (isset($_POST['days']) && in_array(3, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Wednesday</option>
                                <option value="4" <?php if (isset($_POST['days']) && in_array(4, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Thursday</option>
                                <option value="5" <?php if (isset($_POST['days']) && in_array(5, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Friday</option>
                                <option value="6" <?php if (isset($_POST['days']) && in_array(6, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Saturday</option>
                                <option value="7" <?php if (isset($_POST['days']) && in_array(7, $_POST['days'])): echo 'selected="selected"'; endif; ?>>Sunday</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="add_event_timer" id="add_event_timer" value="add_event_timer">Add Timer</button>
                    </div>
                </form>
                <script>
