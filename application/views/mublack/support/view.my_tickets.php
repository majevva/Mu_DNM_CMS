            ...
            <div id="content_center">
                <div class="box-style1" style="margin-bottom:55px;">
                    <h2 class="title">
                        ...
                        <div style="float:right;"><a class="custom_button" href="<?php echo $this->config->base_url; ?>support"><?php echo __('New Request'); ?></a></div>
                    </h2>
                    <div class="entry">
                        <table class="ranking-table">
                            ...
                            <?php
                                if(!empty($ticket_list)):
                                    ...
                                    ?>
                                    <div class="e_note"><?php echo __('You have no support requests.'); ?></div>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
