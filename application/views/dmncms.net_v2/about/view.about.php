...
<div class="news_main">
	<div class="heding">
		<h2><?php echo _('About Server'); ?></h2>
	</div>
	<div class="content_rght_info m5">
		<div class="other">
            <h2 class="title">
			<?php echo _('Information About'); ?><?php echo $this->config->config_entry('main|servername'); ?>
			</h2>
            <div class="entry">
