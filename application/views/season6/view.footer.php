...
<div id="footer">
    <div id="copyright">
        <p><?php echo _('Copyright'); ?> <?php echo date('Y'); ?> &copy; <?php echo $this->config->config_entry('main|servername'); ?>. <?php echo _('All Rights Reserved.'); ?></p>
        <p style=""><?php echo _('Powered By'); ?> <a href="http://dmncms.net" target="_blank">DmN MuCMS</a></p>
    </div>
</div>
<div id="loading"><img
