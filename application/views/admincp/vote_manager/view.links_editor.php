                            ...
                            <div class="controls">
                                <select id="hours" name="hours">
                                    ...
                                    for ($i = 1; $i <= 48; $i++):
                                        ...
                                        ?>
                                        <option value="<?php echo $i; ?>" <?php echo $selected; ?>><?php echo $i; ?>H
                                        </option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="voting_api" name="voting_api">
                                    <option  value="0" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 0) { echo 'selected="selected"';} ?>>None</option>
                                    <option  value="1" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 1) { echo 'selected="selected"';} ?>>XtremeTop100.com</option>
                                    <option  value="2" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 2) { echo 'selected="selected"';} ?>>MMOTOP.ru</option>
                                    <option  value="7" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 7) { echo 'selected="selected"';} ?>>MuServer.top</option>
                                    <option  value="3" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 3) { echo 'selected="selected"';} ?>>GTop100.com</option>
                                    <option  value="4" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 4) { echo 'selected="selected"';} ?>>TopG.org</option>
                                    <option  value="5" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 5) { echo 'selected="selected"';} ?>>Top100Arena.com</option>
                                    <option  value="6" <?php if (isset($_POST['voting_api']) && $_POST['voting_api'] == 6) { echo 'selected="selected"';} ?>>MMOServer.pro</option>
                                </select>
