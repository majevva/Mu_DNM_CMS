                            ...
                            <form method="post" action="<?php echo $this->config->base_url; ?>registration"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                class="validate[required,minSize[<?php echo $config['min_username']; ?>],maxSize[<?php echo $config['max_username']; ?>]]"
                                    ...
                                    <?php if($config['email_validation'] == 0 || $config['generate_password'] == 0): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input
                                                    class="validate[required,minSize[<?php echo $config['min_password']; ?>],maxSize[<?php echo $config['max_password']; ?>],equals[pass]]"
