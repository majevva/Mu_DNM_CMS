                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="title" id="title" value="<?php echo $guide['title'];?>"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" id="guide" name="guide" rows="4"><?php echo $guide['text'];?></textarea>
                            </div>
                        </div>
