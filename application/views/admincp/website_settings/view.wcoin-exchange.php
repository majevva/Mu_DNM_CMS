            ...
            <div class="box-content">
                <form class="form-horizontal" method="POST" action="" id="wcoin_settings_form">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="reward_coin" name="reward_coin" value="" placeholder="1"/>
                            <p class="help-block">How much credits will cost 1 wcoin. Value can be set as negative also.</p>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="min_rate" name="min_rate" value="" placeholder="1"/>
                            <p class="help-block">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="edit_wcoin_settings" id="edit_wcoin_settings">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
