		...
		<div class="other">
            <?php
                if (empty($department_list)):
                    echo '<div style="padding: 0 30px 0px 50px;"><div class="i_note">' . _('Currently no active support departments.') . '</div></div>';
                else:
                    echo $css;
                    echo $js;
                    ?>
                        ...
                        <h2 class="title">
                            <?php echo _('Send support ticket'); ?>
                            <div style="float:right;"><a class="custom_button"
                                                         href="<?php echo $this->config->base_url; ?>support/my-tickets"><?php echo _('View My Tickets'); ?></a>
                            </div>
                        </h2>
                        <div class="entry">
                            <div class="form">
                                ...
                                <form method="post" action="<?php echo $this->config->base_url; ?>support"
                                    ...
                                    <table>
                                        <tr>
                                            <td style="width: 200px;"><?php echo _('Subject'); ?>
                                                :
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="width: 200px;"><?php echo _('Department'); ?>
                                                :
                                            </td>
                                            <td>
                                                <select name="department" id="department" class="validate[required]">
                                                    <option
                                                        value=""><?php echo _('Select Department'); ?></option>
                                                    <?php
                                                    foreach ($department_list as $key => $department):
                                                        if ($department['pay_per_incident']) {
                                                            $payment = ' (' . $department['pay_per_incident'] . ' ' . $this->website->translate_credits($department['payment_type'], $this->session->userdata(array('user' => 'server'))) . ')';
                                                        } else {
                                                            $payment = '';
                                                        }
                                                        ?>
                                        ...
                                        <tr>
                                            <td style="width: 200px;"><?php echo _('Priority'); ?>
                                                :
                                            </td>
                                            <td>
                                                <select name="priority" id="priority" class="validate[required]">
                                                    <option
                                                        value=""><?php echo _('Select Priority'); ?></option>
                                                    <?php
                                        ...
                                        <tr>
                                            <td style="width: 200px;"><?php echo _('Character'); ?>
                                                :
                                            </td>
                                            <td>
                                                <select name="character" id="character" class="validate[required]">
                                                    <option
                                                        value=""><?php echo _('Select Character'); ?></option>
                                                    <?php
                                                    if ($char_list):
