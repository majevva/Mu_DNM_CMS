            ...
            <div id="content_center">
                <div class="box-style1" style="margin-bottom:55px;">
                    ...
                    if (isset($error)):
                        ...
                        <div class="entry">
                            <table class="ticket left" style="width:320px;" cellspacing="0">
                                <thead>
                                <th><?php echo $this->session->userdata(array('user' => 'username')); ?></th>
                            ...
                            ?>
                            <table class="ticket right" style="width:180px;" cellspacing="0">
                                <tbody>
                                <tr>
                                    <td><?php echo _('Request Id'); ?></td>
                                ...
                                <tr>
                                    <td><?php echo _('Time Elapsed'); ?></td>
                                    <td><?php echo $time_elapsed; ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo _('Department'); ?></td>
                                ...
                                <?php if ($ticket_data['status'] != 3) { ?>
                                    <tr id="tr_resolved">
                                        <td colspan="2" style="text-align:center;"><a href="" id="mark_resolved"
                                                                                      data-id="<?php echo $ticket_data['id']; ?>"><?php echo _('Mark As Resolved'); ?></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <?php
                                    ...
                                    if ($attachment != false) {
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align:center;">
                                                <div><?php echo _('Attached Files'); ?></div>
                                                <div>
                                                    <?php
                            ...
                            if (!empty($ticket_replies)):
                                ...
                                foreach ($ticket_replies AS $replies):
                                    ...
                                    <table class="ticket" style="width:100%;" cellspacing="0">
                                        <thead>
                                        <th style="<?php echo $color; ?>"><?php echo ($replies['sender'] == $this->session->userdata(array('user' => 'username'))) ? 'Me' : $replies['sender']; ?></th>
                                ...
                                <form method="post" action="" id="support_reply_form">
                                    ...
                                    <div style="text-align:center;width:100%;">
                                        <button type="submit" name="submit_reply"
                                                class="button-style2"><?php echo _('Submit'); ?></button>
                                    </div>
                                </form>
                                <script>
                                    $(document).ready(function () {
