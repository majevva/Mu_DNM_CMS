                    ...
                    <form class="form-horizontal" method="POST" action="">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="permanent_ban" name="permanent_ban" value="1" data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group" id="ban_time">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead datetimepicker" id="time" name="time" value=""/>
