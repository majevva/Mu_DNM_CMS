                    ...
                    <div id="ucp_info">
                        <ul align="left">
                            ...
                            if ($this->session->userdata('vip')){
                                $price -= ($price / 100) * $this->session->userdata(array('vip' => 'change_name_discount'));
                            }
                            ?>
                            <li><?php echo _('Character Name Change Cost') . ' '. vsprintf(_('<span style="color:red;">%d</span> %s'), array($price, $this->website->translate_credits($this->config->config_entry('changename|price_type'), $this->session->userdata(array('user' => 'server'))))); ?></li>
                            <li><?php echo sprintf(_('Character Name can be 4-%d chars long!'), $this->config->config_entry('changename|max_length')); ?></li>
