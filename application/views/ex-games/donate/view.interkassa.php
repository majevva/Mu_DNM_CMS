...
<div id="content">
    <div id="box1">
        ...
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('With Interkassa'); ?></h2>
                            ...
                            foreach($interkassa_packages as $packages){
                                echo '<ul id="paypal-options">
									<li>
										...
										<a class="right custom_button" href="' . $this->config->base_url . 'donate/interkassa/' . $packages['id'] . '">' . _('Buy Now') . '</a>
									</li>
							</ul>';
                            }
                        }
                        else{
                            echo '<div class="i_note">' . _('No Interkassa Packages Found.') . '</div>';
                        }
                    }
                ?>
            </div>
