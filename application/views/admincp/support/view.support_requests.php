                ...
                <form class="form-horizontal" method="POST" action="" id="ticket_form">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th>Status</th>
                            <th>Action</th>
                            <th><input type="checkbox" name="check_all" id="check_all_tickets" data-no-uniform="true"/></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        if (!empty($tickets)) {
                            foreach ($tickets AS $ticket) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('d/m/Y g:i a', $ticket['create_time']); ?></td>
                                    ...
                                    <td><input type="checkbox" name="id[<?php echo $ticket['id']; ?>]" data-no-uniform="true"/></td>
                                </tr>
                                <?php
                            }
                        } else {
