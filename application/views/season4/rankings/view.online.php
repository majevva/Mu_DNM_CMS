                            ...
                            <?php
                                ...
                                foreach($online as $players):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($config['online_list']['display_country'] == 1): ?><img
                                                src="<?php echo $this->config->base_url; ?>assets/flags/<?php echo $players['country']; ?>.gif"
                                                title="<?php echo $players['country']; ?>" /><?php endif; ?> <a
