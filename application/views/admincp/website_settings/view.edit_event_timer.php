<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo $this->config->base_url; ?>admincp/manage-settings/event-timers">Event Timer Settings</a>
            </li>
        </ul>
    </div>
    <?php
    ...
    <div class="row-fluid">
        <div class="span12">
            <p class="left">
                <a href="<?php echo $this->config->base_url; ?>admincp/add-event-timers" class="btn btn-large btn-primary">
                    Add New Timer</a>
            </p>
            ...
            <div class="box-content">
                <form class="form-horizontal" method="POST" action="" id="edit_event_timer">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input-xlarge" name="name" id="name"
                                   value="<?php if (isset($event_data['name'])): echo $event_data['name']; endif; ?>" required />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="days" name="days[]" multiple data-rel="chosen" required>
                                <option value="0" <?php if (isset($event_data['days']) && !is_array($event_data['days'])): echo 'selected="selected"'; endif; ?>>Every Day</option>
                                <option value="1" <?php if (isset($event_data['days']) && is_array($event_data['days']) && array_key_exists(1, $event_data['days'])): echo 'selected="selected"'; endif; ?>>Monday</option>
                                <option value="2" <?php if (isset($event_data['days']) && is_array($event_data['days']) && array_key_exists(2, $event_data['days'])): echo 'selected="selected"'; endif; ?>>Tuesday</option>
                                <option value="3" <?php if (isset($event_data['days']) && is_array($event_data['days']) && array_key_exists(3, $event_data['days'])): echo 'selected="selected"'; endif; ?>>Wednesday</option>
                                <option value="4" <?php if (isset($event_data['days']) && is_array($event_data['days']) && array_key_exists(4, $event_data['days'])): echo 'selected="selected"'; endif; ?>>Thursday</option>
                                <option value="5" <?php if (isset($event_data['days']) && is_array($event_data['days']) && array_key_exists(5, $event_data['days'])): echo 'selected="selected"'; endif; ?>>Friday</option>
                                <option value="6" <?php if (isset($event_data['days']) && is_array($event_data['days']) && array_key_exists(6, $event_data['days'])): echo 'selected="selected"'; endif; ?>>Saturday</option>
                                <option value="7" <?php if (isset($event_data['days']) && is_array($event_data['days']) && array_key_exists(7, $event_data['days'])): echo 'selected="selected"'; endif; ?>>Sunday</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="edit_event_timer" id="edit_event_timer" value="edit_event_timer">Edit Timer</button>
                    </div>
                </form>
                <script>
