                    ...
                    if(empty($department_list)):
                        ...
                        <div class="box-style1" style="margin-bottom:55px;">
                            <h2 class="title">
                                ...
                                <div style="float:right;"><a class="custom_button" href="<?php echo $this->config->base_url; ?>support/my-tickets"><?php echo __('View My Tickets'); ?></a></div>
                            </h2>
                            <div class="entry">
                                <div class="form">
                                    <?php
                                    ...
                                    ?>
                                    <form method="post" action="<?php echo $this->config->base_url; ?>support" id="support_form" enctype="multipart/form-data">
