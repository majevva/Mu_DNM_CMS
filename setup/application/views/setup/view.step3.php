                                ...
                                <form name="sql_config_form" method="POST" action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sql_host" name="sql_host"
                                               placeholder="127.0.0.1" value="<?php if(isset($ip)){echo $ip;}?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="key">SQL Port</label>
                                        <input type="text" class="form-control" id="sql_host" name="sql_port"
                                               placeholder="1433" value="<?php if(isset($port)){echo $port;}?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="key">SQL Username</label>
                                        <input type="text" class="form-control" id="sql_user" name="sql_user"
                                               placeholder="sa" value="<?php if(defined('USER')){ echo USER;}?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="key">SQL Password</label>
                                        <input type="password" class="form-control" id="sql_pass" name="sql_pass"
                                               placeholder="12345" value="<?php if(defined('PASS')){ echo PASS;}?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="key">Website Database Name</label>
                                        <input type="text" class="form-control" id="sql_web_db" name="sql_web_db"
                                               placeholder="dmncms" value="<?php if(defined('WEB_DB')){ echo WEB_DB;}?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="sql_driver">Sql Connection Extension:</label>
                                        <select class="form-control" id="sql_driver" name="sql_driver">
                                            <option value="mssql" <?php if(defined('DRIVER') && DRIVER == 'mssql'){ echo 'selected="selected"';}?>>MSSQL</option>
                                            <option value="pdo_sqlsrv" <?php if(defined('DRIVER') && DRIVER == 'pdo_sqlsrv'){ echo 'selected="selected"';}?>>PDO SQLServ</option>
                                            <option value="pdo_odbc" <?php if(defined('DRIVER') && strtolower(DRIVER) == 'pdo_odbc'){ echo 'selected="selected"';}?>>PDO ODBC</option>
                                            <option value="pdo_dblib" <?php if(defined('DRIVER') && DRIVER == 'pdo_dblib'){ echo 'selected="selected"';}?>>PDO DBLIB</option>
                                        </select>
                                    </div>
