        ...
        <div class="box-style1" style="margin-bottom: 20px;">
            ...
            <div class="entry">
                ...
                <script type="text/javascript">
                    ...
                    var amountof = ['<?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server']));?>', '<?php echo __('WCoins');?>'], willreceive = ['<?php echo __('WCoins');?>', '<?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server']));?>'];
                ...
                <div
                    class="i_note"><?php echo vsprintf(__('Minimal exchange rate is %d %s'), [$wcoin_config['min_rate'], $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server']))]); ?></div>
