                ...
                <div id="credits_items">
                    <?php
                        if($credits_items != false){
                                ...
                                <div style="padding-top:10px;">
                                    ...
                                    <div style="float:right;">
                                        <button id="buy_items_credits"
                                                class="btn-enter auth"><?php echo _('Buy Selected'); ?></button>
                                    </div>
                                </div>
                            </form>
                            ...
                            ?>
                            <div
                                class="i_note"><?php echo sprintf(_('No items for %s in cart.'), $this->config->config_entry('credits_' . $this->session->userdata(['user' => 'server']) . '|title_1')); ?></div>
                            <?php
                        }
                    ?>
                </div>
                ...
                <div id="gcredits_items">
                    <?php
                        if($gcredits_items != false){
                            ...
                            ?>
                            <div
                                class="i_note"><?php echo sprintf(_('No items for %s in cart.'), $this->config->config_entry('credits_' . $this->session->userdata(['user' => 'server']) . '|title_2')); ?></div>
                            <?php
                        }
                    ?>
                </div>
