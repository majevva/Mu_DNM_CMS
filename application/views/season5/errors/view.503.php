...
<head>
    ...
    <title><?php echo $this->meta->request_meta_title(); ?>
        :: <?php echo _('Page Under Maintenance'); ?></title>
...
<section>
    <div class="container">
        <div class="row row1">
            <div class="col-md-12">
                <h3 class="center capital f1 wow fadeInLeft"><?php echo _('Something went Wrong!'); ?></h3>

                <h1 id="error" class="center wow fadeInRight">503</h1>

                <p class="center wow bounceIn"><?php echo _('Page Under Maintenance'); ?>
                    .</p>

                <p class="center wow bounceIn"><?php echo _('We will be back shortly'); ?>
                    .</p>
            </div>
        </div>
