            ...
            <div class="box-content">
                <form class="form-horizontal" method="POST" action="" id="event_settings_form">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="active" name="active">
                                <option value="0" <?php if(isset($event_config['active']) && $event_config['active'] == 0){echo 'selected="selected"';}?>>Inactive</option>
                                <option value="1" <?php if(isset($event_config['active']) && $event_config['active'] == 1){echo 'selected="selected"';}?>>Active</option>
                            </select>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="edit_event_settings" id="edit_event_settings">Save changes</button>
                    </div>
                </form>
            </div>
            <div class="box-header well">
