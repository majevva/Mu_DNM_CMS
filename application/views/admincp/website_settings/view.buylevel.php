                ...
                foreach ($buylevel_config AS $server => $settings) {
                    ...
                    <div class="box-content">
                        <div class="box span9">
                            ...
                            ?>
                            <div class="box-content">
                                <form class="form-horizontal" method="POST" action="" id="max_level_settings_form_<?php echo $server;?>">
                                    <fieldset>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="max_level"
                                                       name="max_level"
                                                       value="<?php echo (isset($settings['max_level'])) ? $settings['max_level'] : ''; ?>" placeholder="999" />
                                                <p class="help-block">Maximum level allowed for purchase.</p>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-primary" name="edit_max_level_settings_<?php echo $server;?>" id="edit_max_level_settings_<?php echo $server;?>">Save changes</button>
                                ...
                                <form class="form-inline">
                                    <fieldset>
                                        <div class="control-group">
                                            <div class="controls">
                                                <label class="radio">
                                                    <input type="radio" name="status_buylevel_<?php echo $server; ?>" data-no-uniform="true"
                                                           value="1"
