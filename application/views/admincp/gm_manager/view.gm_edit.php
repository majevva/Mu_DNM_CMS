                    ...
                    <fieldset>
                            ...
                            <div class="controls">
                                <label class="checkbox inline">
                                    <input type="checkbox" id="ban_acc" name="ban_acc" value="1"
                                           <?php if ($gm_info['can_ban_acc'] == 1){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                </label>
                            ...
                            <div class="controls">
                                <label class="checkbox inline">
                                    <input type="checkbox" id="ban_char" name="ban_char" value="1"
                                           <?php if ($gm_info['can_ban_char'] == 1){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                </label>
                            ...
                            <div class="controls">
                                <label class="checkbox inline">
                                    <input type="checkbox" id="search_acc" name="search_acc" value="1"
                                           <?php if ($gm_info['can_search_acc'] == 1){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                </label>
                            ...
                            <div class="controls">
                                <label class="checkbox inline">
                                    <input type="checkbox" id="acc_details" name="acc_details" value="1"
                                           <?php if ($gm_info['can_view_acc_details'] == 1){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                </label>
                        ...
                        <div id="gm_command_list_igcn" style="display:<?php echo $igcn_diplay; ?>;">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="event_management" name="event_management" value="1"
                                               <?php if (isset($event) && $event == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="fireworks" name="fireworks" value="2"
                                               <?php if (isset($fireworks) && $fireworks == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="guild_commands" name="guild_commands" value="8"
                                               <?php if (isset($guild) && $guild == true){ ?>checked="checked"<?php } ?> data-no-uniform="true"> 
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="battle_soccer_commands" name="battle_soccer_commands"
                                               value="16"
                                               <?php if (isset($battle_soccer) && $battle_soccer == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="chat_dc_move" name="chat_dc_move" value="4"
                                               <?php if (isset($dc) && $dc == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="item" name="item" value="32"
                                               <?php if (isset($item) && $item == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="hide" name="hide" value="128"
                                               <?php if (isset($hide) && $hide == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="ban" name="ban" value="512"
                                               <?php if (isset($ban) && $ban == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="pk_set" name="pk_set" value="64"
                                               <?php if (isset($pk_set) && $pk_set == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="skin" name="skin" value="256"
                                               <?php if (isset($skin) && $skin == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="gm_shop" name="gm_shop" value="1024"
                                               <?php if (isset($gm_shop) && $gm_shop == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="invisible_to_monsters" name="invisible_to_monsters" value="2048" <?php if (isset($invisible_to_monsters) && $invisible_to_monsters == true){ ?>checked="checked"<?php } ?> data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="input-xlarge datepicker" id="valid_until"
                                        ...
                                        echo date('m/d/Y', strtotime($valid_until));
                                    } else {
