            ...
            <div class="box-content">
                <form class="form-horizontal" method="POST" action="" id="pre_defined_template_form">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="load_pre_defined_template" id="load_pre_defined_template">Load Template</button>
                    </div>
                </form>
            </div>
        </div>
				...
				<form class="form-horizontal" method="POST" action="" id="sql_table_settings_form">
						...
						<div class="controls">
							<select id="server" name="server">
								<?php foreach ($server_list as $key => $server): ?>
									<option value="<?php echo $key; ?>" <?php if($default_server == $key){ echo 'selected="selected"';}?>><?php echo  $server['title'];?></option>
								<?php endforeach; ?>
							</select>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="resets_custom-db" name="resets_custom-db" value=""/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="resets-table" name="resets-table" value="" placeholder="Character" required/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="resets-column" name="resets-column" value="" placeholder="resets" />
							<p class="help-block">Resets column name.</p>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="resets-identifier_column">Identifier Column <span style="color:red;">*</span></label>
						<div class="controls">
							<input type="text" class="input-large" id="resets-identifier_column" name="resets-identifier_column" value="" placeholder="Name" required/>
							<p class="help-block">Column name by which can identify resets, usually character name column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<br />
					<div class="control-group">
						<label class="control-label" for="grand_resets-db">Database <span style="color:red;">*</span></label>
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="grand_resets_custom-db" name="grand_resets_custom-db" value="" />
							<p class="help-block">Database where grand resets column is located.</p>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="grand_resets-table">Table <span style="color:red;">*</span></label>
						<div class="controls">
							<input type="text" class="input-large" id="grand_resets-table" name="grand_resets-table" value="" placeholder="Character" required/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="grand_resets-column" name="grand_resets-column" value="" placeholder="grand_resets" />
							<p class="help-block">Grand Resets column name.</p>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="grand_resets-identifier_column">Identifier Column <span style="color:red;">*</span></label>
						<div class="controls">
							<input type="text" class="input-large" id="grand_resets-identifier_column" name="grand_resets-identifier_column" value="" placeholder="Name" required/>
							<p class="help-block">Column name by which can identify grand resets, usually character name column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="wcoins_custom-db" name="wcoins_custom-db" value=""/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="wcoins-table" name="wcoins-table" value="" placeholder="MEMB_INFO"/>
							<p class="help-block">Table where wcoins column is located.</p>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="wcoins-column">Column <span style="color:red;">*</span></label>
						<div class="controls">
							<input type="text" class="input-large" id="wcoins-column" name="wcoins-column" value="" placeholder="WCoin" />
							<p class="help-block">WCoins column name.</p>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="wcoins-identifier_column">Identifier Column <span style="color:red;">*</span></label>
						<div class="controls">
							<input type="text" class="input-large" id="wcoins-identifier_column" name="wcoins-identifier_column" value="" placeholder="memb___id" />
							<p class="help-block">Column name by which can identify wcoins, usually member username column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<br />
					<div class="control-group">
						<label class="control-label" for="master_level-db">Database <span style="color:red;">*</span></label>
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="master_level_custom-db" name="master_level_custom-db" value="" />
							<p class="help-block">Database where master level column is located.</p>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="master_level-table">Table <span style="color:red;">*</span></label>
						<div class="controls">
							<input type="text" class="input-large" id="master_level-table" name="master_level-table" value="" placeholder="Character" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="master_level-column" name="master_level-column" value="" placeholder="MasterLevel" />
							<p class="help-block">Master Level column name.</p>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="master_level-identifier_column">Identifier Column <span style="color:red;">*</span></label>
						<div class="controls">
							<input type="text" class="input-large" id="master_level-identifier_column" name="master_level-identifier_column" value="" placeholder="Name" />
							<p class="help-block">Column name by which can identify master level, usually character name column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="bc_custom-db" name="bc_custom-db" value=""/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="bc-column" name="bc-column" value="" placeholder="Score" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="bc-identifier_column" name="bc-identifier_column" value="" placeholder="Name" />
							<p class="help-block">Column name by which can identify score, usually character name column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="ds_custom-db" name="ds_custom-db" value=""/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="ds-column" name="ds-column" value="" placeholder="Score" />
							<p class="help-block">Score column name.</p>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="ds-identifier_column" name="ds-identifier_column" value="" placeholder="Name" />
							<p class="help-block">Column name by which can identify score, usually character name column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="cc_custom-db" name="cc_custom-db" value=""/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="cc-column" name="cc-column" value="" placeholder="Score" />
							<p class="help-block">Score column name.</p>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="cc-column2" name="cc-column2" value="" placeholder="PKillCount" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="cc-column3" name="cc-column3" value="" placeholder="MKillCount" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="cc-identifier_column" name="cc-identifier_column" value="" placeholder="Name" />
							<p class="help-block">Column name by which can identify score, usually character name column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="cs_custom-db" name="cs_custom-db" value=""/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="cs-column" name="cs-column" value="" placeholder="Score" />
							<p class="help-block">Score column name.</p>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="cs-identifier_column" name="cs-identifier_column" value="" placeholder="Name" />
							<p class="help-block">Column name by which can identify score, usually character name column.</p>
						</div>
					</div>
					<div class="box-header well">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input style="display:none;" type="text" class="input-large" id="duels_custom-db" name="duels_custom-db" value=""/>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="duels-column" name="duels-column" value="" placeholder="Win" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="duels-column2" name="duels-column2" value="" placeholder="Lose" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" id="duels-identifier_column" name="duels-identifier_column" value="" placeholder="Name" />
							<p class="help-block">Column name by which can identify score, usually character name column.</p>
						</div>
					</div>
					 <div class="form-actions">
							<button type="submit" class="btn btn-primary" name="edit_sql_table_settings" id="edit_sql_table_settings" value="Save changes">Save changes</button>
						</div>
				</form>
			</div>
		</div>
