                ...
                if (isset($not_found)) {
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            $.extend(DmNConfig, {max_stats: <?php echo $this->config->config_entry('character_'.$this->session->userdata(array('user' => 'server')).'|max_stats');?>});
                            App.calculateStats();
                        });
                    </script>
                <?php
                ...
                ?>
                    <div class="form">
                        <form method="POST" action="" id="add_stats" name="add_stats">
                            <table>
                                <tr>
                                    <td style="width:150px;"><?php echo _('Level Up Points'); ?>
                                        :
                                    </td>
                                ...
                                <?php
                                if (in_array($this->Mcharacter->char_info['Class'], array(64, 65, 66))) {
                                    ?>
                                    <tr>
                                        <td><?php echo _('Command'); ?> [<span
                                                class="stats_now"
