                                    ...
                                    <?php echo $data['level']; ?><?php } ?>
                                            ...
                                            <?php
                                                if($data['gres_info'] != false){
                                                    if($data['gres_info']['money_x_reset'] == 1){
                                                        echo $this->website->zen_format($data['gres_info']['money'] * ($data['gresets'] + 1));
                                                    }
                                                    else{
                                            ...
                                            <?php
                                                ...
                                                if($data['gres_info'] != false){
                                                    if($data['gres_info']['bonus_credits'] > 0){
                                                        $reward .= $this->config->config_entry('credits_' . $this->session->userdata(['user' => 'server']) . '|title_1') . ' ' . _('Bonus') . ' + ' . $data['gres_info']['bonus_credits'] . '<br />';
                                                    }
                                                    if($data['gres_info']['bonus_gcredits'] > 0){
                                                        $reward .= $this->config->config_entry('credits_' . $this->session->userdata(['user' => 'server']) . '|title_2') . ' ' . _('Bonus') . ' + ' . $data['gres_info']['bonus_gcredits'] . '<br />';
                                                    }
                                        ...
                                        <td>
                                            <?php if($data['gres_info'] != false){ ?><a href="#"
                                                                                        id="greset-char-<?php echo bin2hex($name); ?>"><?php echo _('Grand Reset'); ?></a><?php }
                                            else{
