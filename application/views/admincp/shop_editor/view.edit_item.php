                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="exetype" name="exetype">
											...
											<option value="9" <?php if($info['exetype'] == 9){ ?>selected="selected"<?php } ?>>Weapons Dark/Blood/Holy Angel</option>
                                            <option value="2"
                                                    <?php if($info['exetype'] == 2){ ?>selected="selected"<?php } ?>>
                                                Shields & Sets
                                            </option>
											<option value="10" <?php if($info['exetype'] == 10){ ?>selected="selected"<?php } ?>>Shields & Sets Dark/Blood/Holy Angel</option>
                                            <option value="3"
