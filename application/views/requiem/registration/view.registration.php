        ...
        <div id="box1">
            ...
            <div id="content_center">
                <div class="box-style1" style="margin-bottom:55px;">
                    <h2 class="title"><?php echo _('Create your account in just few clicks'); ?></h2>
                            ...
                            <form method="post" action="<?php echo $this->config->base_url; ?>registration" id="registration_form">
                                <table>
									...
									<tr>
										...
										<td>
											<input class="validate[required,minSize[<?php echo $config['min_username'];?>],maxSize[<?php echo $config['max_username'];?>]]" type="text" name="user" id="user" value=""/>
										</td>
									</tr>
									...
									<?php if (isset($show_ref) && $show_ref == true): ?>
										<tr>
											<td><?php echo _('Referrer'); ?>:</td>
											<td>
												<input type="text" name="referrer" id="referrer" value="<?php echo $ref; ?>" readonly/>
									...
									<tr>
										<td colspan="2" align="left">
											...
											<?php echo _('I have read and agree to the <a href="" id="rules_dialog"><b>game rules.</b></a>'); ?>
										</td>
									</tr>
                ...
                <script type="text/javascript">
					$(document).ready(function () {
						...
						$("#rules_dialog").on('click', function (e) {
							e.preventDefault();
							App.initializeRulesDialog('<?php echo _('Server Rules'); ?>');
						});
					});
				</script>
            </div>
