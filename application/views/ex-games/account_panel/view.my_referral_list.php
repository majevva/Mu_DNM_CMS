                    ...
                    <div id="ucp_info">
                        <div class="full">
                            <table width="99%" style="padding:3px;">
                                <tr>
                                    <td><input type="text"
                                               value="<?php echo $this->config->base_url; ?>registration/index/<?php echo $this->session->userdata(['user' => 'username']); ?>/<?php echo $this->session->userdata(['user' => 'server']); ?>"
                    ...
                    <script>
                        $(document).ready(function () {
                            $('a[id^="ref-reward-"]').on('click', function (e) {
                                e.preventDefault();
                                var char = $(this).attr("id").split("-").slice(-2)[0];
                                var reward = $(this).attr("id").split("-").slice(-1)[0];
                                                    ...
                                                    <td>
                                                        <table style="border-collapse: collapse;border:0;">
                                                            <tr>
                                                                ...
                                                                <td><?php echo _('Resets'); ?>
                                                                    : <?php echo $char['resets']; ?></td>
                                                                <td><?php echo _('GResets'); ?>
                                                    ...
                                                    <td>
                                                        <?php
                                                            if(!empty($ref_rewards)){
                                                                ...
                                                                $html = '<div class="ref-reward-dropdown"><button class="btn-enter auth">' . _('View Reward List') . '</button><div class="ref-reward-dropdown-content">';
