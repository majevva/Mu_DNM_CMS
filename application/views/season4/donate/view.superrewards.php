...
<div id="content">
    <div id="box1">
        ...
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('With SuperRewards'); ?></h2>
            ...
            <div class="entry">
                <div
                    ...
                    <div style="text-align: center;">
                        <iframe
                            src="https://wall.superrewards.com/super/offers?h=<?php echo $donation_config['app_hash']; ?>&uid=<?php echo urlencode($this->session->userdata(['user' => 'username']) . '-server-' . $this->session->userdata(['user' => 'server'])); ?>"
