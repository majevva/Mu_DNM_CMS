...
<div id="content">
    <div id="box1">
        <div class="title1">
            <h1><?php echo _('Exchange Wcoins'); ?></h1>
        </div>
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('Exchange'); ?><?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server'])); ?><?php echo _('To Wcoins'); ?></h2>
            ...
            <div class="entry">
                ...
                <script type="text/javascript">
                    ...
                    var amountof = ['<?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server']));?>', '<?php echo _('WCoins');?>'], willreceive = ['<?php echo _('WCoins');?>', '<?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server']));?>'];
                ...
                <div
                    class="i_note"><?php echo vsprintf(_('Minimal exchange rate is %d %s'), [$wcoin_config['min_rate'], $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server']))]); ?></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="exchange_type" id="exchange_type">
                                            <option
                                                value="1"><?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server'])); ?><?php echo _('To'); ?><?php echo _('WCoins'); ?></option>
                                            <option
                                                value="2"><?php echo _('WCoins'); ?><?php echo _('To'); ?><?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(['user' => 'server'])); ?></option>
                                        </select>
                                    </td>
                                </tr>
                            <?php } ?>
