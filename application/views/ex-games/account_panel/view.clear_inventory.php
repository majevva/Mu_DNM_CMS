...
<div id="content">
    <div id="box1">
        <div class="title1">
            <h1><?php echo _('Clear Inventory'); ?></h1>
        </div>
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('Clear character inventory, equipment etc..'); ?></h2>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="inventory"
                                            ...
                                            <br/> <input type="checkbox" id="store" name="store"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="submit" id="clear_inv_button"
                                                    class="btn-enter auth"><?php echo _('Clear Inventory'); ?></button>
                                        </td>
                                    </tr>
                                </table>
                            </form>
