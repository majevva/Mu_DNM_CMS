...
<div class="news_main">
	<div class="heding">
		<h2><?php echo _('Warehouse'); ?></h2>
	</div>
	<div class="content_rght_info m5">
		<div class="other">
            <h2 class="title">
				<?php echo _('View or sell your items'); ?>		
			</h2>
			<div class="entry">
                ...
                if ($this->config->config_entry('market|module_status') == 1){
                        ...
                        function calculate_tax(val) {
							...
							$(document).ready(function () {
								$('#highlight').on('click', function(){	
									if(this.checked) {
										App.notice('<?php echo _('Info');?>', 'success', '<?php echo vsprintf(_('You Item Will Be Highlighted In Market. Price %d %s.'), array($this->config->config_entry('market|price_highlight'), $this->config->config_entry('credits_' . $this->session->userdata(array('user' => 'server')) . '|title_1'))); ?>', 1);
									}
									else{
										$('.message-box').hide();
									}
                    ...
                    <div id="option_buttons" style="display:none;">
                        <button type="submit" class="flatbtn-blu"
                        ...
                        <?php if ($this->config->config_entry('warehouse|allow_move_to_web_warehouse') == 1) { ?>
                            <button type="submit" class="flatbtn-blu" style="float:right;"
                        ...
                        <form method="post" action="<?php echo $this->config->base_url; ?>warehouse"
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit"
                                                id="sell_item_button"><?php echo _('Sell Items'); ?></button>
                                    </td>
                                </tr>
                            </table>
                        </form>
