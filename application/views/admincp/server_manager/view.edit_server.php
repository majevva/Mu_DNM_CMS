                ...
                if (isset($not_found)) {
                    ...
                    <form class="form-horizontal" method="post" action="">
                        <fieldset>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="title">Server Title <span style="color:red;">*</span></label>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="gs_ip">GameServer IP <span style="color:red;">*</span></label>
