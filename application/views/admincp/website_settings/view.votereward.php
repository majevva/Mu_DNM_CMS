    ...
    <div class="row-fluid">
        <div class="span12">
            <ul class="nav nav-pills">
				<li role="presentation"><a href="<?php echo $this->config->base_url;?>admincp/vote-links">Voting Link Editor</a></li>
                <?php 
				$i = 0;
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade in <?php if($i == 1){?>active<?php }?>" id="<?php echo $key;?>">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="votereward_settings_form_<?php echo $key;?>">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="req_char" name="req_char">
										<option
											value="0" <?php if($val['req_char'] == 0){echo 'selected="selected"';}?>>No
										</option>
										<option
											value="1" <?php if($val['req_char'] == 1){echo 'selected="selected"';}?>>Yes
										</option>
									</select>
								</div>
							</div>
                            ...
                            <div class="control-group">
								...
								<div class="controls">
									<select id="xtremetop_same_acc_vote" name="xtremetop_same_acc_vote">
										<option
											value="0" <?php if($val['xtremetop_same_acc_vote'] == 0){echo 'selected="selected"';}?>>No
										</option>
										<option
											value="1" <?php if($val['xtremetop_same_acc_vote'] == 1){echo 'selected="selected"';}?>>Yes
										</option>
									</select>

									<p class="help-block">Allow to vote for xtremetop100 links from same acc but different
										ip.</p>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									...
									<p class="help-block">XtremeTop100 link numbers seperated by comma. They are autoloaded
										no need to edit this field.</p>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="count_down">Count Down </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="count_down" name="count_down" value="<?php echo $val['count_down'];?>" placeholder="60" required/>

									<p class="help-block">How long will take voting for link before vote submission value in seconds</p>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select id="is_monthly_reward" name="is_monthly_reward">
										<option
											value="0" <?php if($val['is_monthly_reward'] == 0){echo 'selected="selected"';}?>>No
										</option>
										<option
											value="1" <?php if($val['is_monthly_reward'] == 1){echo 'selected="selected"';}?>>Yes
										</option>
									</select>
								</div>
							</div>  
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<p class="help-block">
									Here you can provide formula how players will be rewarded. Ex: <span style="color:green;">5000 - ({position} * 450)</span> in result 1st place would receive 4650 credits but 10th place 500
									Available variables <ul><li>{position} - player position</li><li>{totalvotes} - player total votes in current month</li></ul>
									</p>
								</div>
							</div>
							<div class="control-group">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_vote_settings" id="edit_vote_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
