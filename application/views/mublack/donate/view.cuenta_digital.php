                            ...
                            foreach($cuenta_digital_packages as $packages){
                                ...
                                echo '<ul id="paypal-options">
									<li>
										...
										<a class="right custom_button" style="margin-top: 8px;" href="' . $this->config->base_url . 'donate/cuenta-digital/' . $packages['id'] . $this->csrf->writeTokenQueryString() . '">' . __('Buy Now') . '</a>
									</li>
							</ul>';
                            }
                        }
