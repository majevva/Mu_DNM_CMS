...
<div id="content">
    <div id="box1">
        ...
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('With PagSeguro'); ?></h2>
                            ...
                            foreach($packages as $package){
                                ...
                                echo '<ul id="paypal-options">
									<li>
										...
										<a class="right custom_button" style="margin-top: 8px;" href="' . $this->config->base_url . 'donate/pagseguro/' . $package['id'] . '">' . _('Buy Now') . '</a>
									</li>
							</ul>';
                            }
                        }
                        else{
                            echo '<div class="i_note">' . _('No PagSeguro Packages Found.') . '</div>';
                        }
                    }
                ?>
            </div>
