                            ...
                            foreach($packages as $package){
                                ...
                                echo '<ul id="paypal-options">
									<li>
										...
										<a class="right custom_button" style="margin-top: 8px;" href="' . $this->config->base_url . 'donate/two-checkout/' . $package['id'] . $this->csrf->writeTokenQueryString() . '">' . __('Buy Now') . '</a>
									</li>
							</ul>';
                            }
                        }
