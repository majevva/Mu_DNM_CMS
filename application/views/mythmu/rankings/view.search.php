...
<div id="content">
    <div id="box1">
        <div class="title1">
            <h1><?php echo _('Search Characters & Guilds'); ?></h1>
        </div>
                ...
                <form method="post" action="">
                    <table>
                        <tr>
                            ...
                            <td>
                                <button type="submit" class="custom_button"><?php echo _('Submit'); ?></button>
                            </td>
                        </tr>
                    </table>
                </form>
                            ...
                            <?php
                                ...
                                foreach($list_players as $result):
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo $result['url']; ?>"><?php echo $result['name']; ?></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        ...
                        <table class="ranking-table">
                            ...
                            <?php
                                ...
                                foreach($list_guilds as $gresult):
                                    ...
                                    <tr>
                                        <td style="text-align:center;"><?php echo($i++); ?></td>
                                        <td><a href="<?php echo $gresult['url']; ?>"><?php echo $gresult['name']; ?></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
