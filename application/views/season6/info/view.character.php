...
<div id="content">
    <div id="box1">
        <div class="title1">
            <h1><?php echo _('Info'); ?></h1>
        </div>
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title">
                <?php $args = $this->request->get_args(); ?>
                <?php echo sprintf(_('Character %s Info'), $this->website->hex2bin($args[0])); ?>
            </h2>
            ...
            <div class="entry">
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td style="width: 240px;">
                                <table style="width:100%;margin: 0 auto;">
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('Character'); ?></td>
                                        <td style="width:50%;text-align: left;"><?php echo $this->Mcharacter->char_info['Name']; ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('Class'); ?></td>
                                        <td style="width:50%;text-align: left;"><?php echo $this->website->get_char_class($this->Mcharacter->char_info['Class']); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('Level'); ?></td>
                                        <td style="width:50%;text-align: left;"><?php echo $this->Mcharacter->char_info['cLevel']; ?></td>
                                    </tr>
									<?php if ($this->config->values('rankings_config', array($args[1], 'player', 'display_master_level')) == 1): ?>
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('MasterLevel'); ?></td>
                                        <td style="width:50%;text-align: left;"><?php echo $this->Mcharacter->char_info['mlevel']; ?></td>
                                    </tr>
									<?php endif; ?>
									<?php if ($this->config->values('rankings_config', array($args[1], 'player', 'display_resets')) == 1): ?>
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('Resets'); ?></td>
                                        <td style="width:50%;text-align: left;"><?php echo $this->Mcharacter->char_info['resets']; ?></td>
                                    </tr>
									<?php endif; ?>
                                    <?php if ($this->config->values('rankings_config', array($args[1], 'player', 'display_gresets')) == 1): ?>
                                        <tr>
                                            <td style="width:50%;text-align: left;"><?php echo _('Grand Reset'); ?></td>
                                            <td style="width:50%;text-align: left;"><?php echo $this->Mcharacter->char_info['grand_resets']; ?></td>
                                        </tr>
                                    <?php endif; ?>
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('PK Level'); ?></td>
                                    ...
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('Location'); ?></td>
                                    ...
                                    <tr>
                                        <td style="width:50%;text-align: left;"><?php echo _('Status'); ?></td>
                                        <td style="width:50%;text-align: left;">
                                            <?php
                                            if ($status != false) {
                                                if ($status['ConnectStat'] == 1) {
                                                    echo '<img src="' . $this->config->base_url . 'assets/' . $this->config->config_entry('main|template') . '/images/online.png" alt="' . _('Online') . '" /> ' . _('Online') . '';
                                                } else {
                                                    echo '<img src="' . $this->config->base_url . 'assets/' . $this->config->config_entry('main|template') . '/images/offline.png" alt="' . _('Offline') . '" /> ' . _('Offline') . '';
                                                }
                                            } else {
                                                echo '<img src="' . $this->config->base_url . 'assets/' . $this->config->config_entry('main|template') . '/images/offline.png" alt="' . _('Offline') . '" /> ' . _('Offline') . '';
                                            }
                    ...
                    <table class="ranking-table">
                        <thead>
                        <tr class="main-tr">
                            <th style="padding-left: 15px;"><?php echo _('Account Information'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>
                                <table style="width:100%;text-align: center;margin: 0 auto;" cellpadding="0"
                                    ...
                                    <?php if ($hidden == false) { ?>
                                        <tr>
                                            <td style="width:40%;text-align: left;padding-left: 15px;"><?php echo _('Characters'); ?>
                                                :
                                            </td>
                                    ...
                                    <?php } ?>
                                    <tr>
                                        <td style="width:40%;text-align: left;padding-left: 15px;"><?php echo _('Last Login'); ?>
                                            :
                                        </td>
                                        <td style="width:60%;text-align: left;padding-left: 15px;">
                                            <?php
                                    ...
                                    <tr>
                                        <td style="width:40%;text-align: left;padding-left: 15px;"><?php echo _('Last Logout'); ?></td>
                                        <td style="width:60%;text-align: left;padding-left: 15px;">
                                            <?php
                                            if ($status != false) {
                ...
                <?php if (!isset($no_guild)){ ?>
                    ...
                    <table class="ranking-table" cellpadding="0" cellspacing="0">
                        <thead>
                        <tr class="main-tr">
                            <th style="padding-left: 15px;"><?php echo _('Guild Info'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>
                                <table style="width: 100%;text-align: center;margin: 0 auto;" cellpadding="0"
                                       cellspacing="0">
                                    <tr>
                                        <td style="width:40%;text-align: left;padding-left: 15px;"><?php echo _('Guild'); ?>
                                            :
                                        </td>
                                        <td style="width:60%;text-align: left;padding-left: 15px;">
                                            <img
                                    ...
                                    <tr>
                                        <td style="width:40%;text-align: left;padding-left: 15px;"><?php echo _('Master'); ?>
                                            :
                                        </td>
                                        <td style="width:60%;text-align: left;padding-left: 15px;">
                                    ...
                                    <tr>
                                        <td style="width:40%;text-align: left;padding-left: 15px;"><?php echo _('Members'); ?>
                                            :
                                        </td>
                ...
                ?>
                    ...
                    <table class="ranking-table" cellpadding="0" cellspacing="0">
                        <thead>
                        <tr class="main-tr">
                            <th style="padding-left: 15px;"><?php echo _('Equipment'); ?></th>
                        </tr>
                        </thead>
                        <tr>
                            <td style="padding:5px;">
                                <?php if (!$hidden) { ?>
                                    <div style="width: 100%;text-align: center;margin-top:10px;">
                                        <div id="inventory"
                                             style="display: inline-block;position:relative; height:407px;width:400px; background:url(<?php echo $this->config->base_url; ?>assets/<?php echo $this->config->config_entry("main|template"); ?>/images/inventories/inv_<?php echo strtolower($this->website->get_char_class($this->Mcharacter->char_info['Class'], true)); ?>.png) no-repeat left top;">
                                ...
                                <?php } else { ?>
                                    <div
                                        class="i_note"><?php echo _('Equipment Hidden'); ?></div>
                                <?php } ?>
                            </td>
                        </tr>
                    </table>
