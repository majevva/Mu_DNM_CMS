                ...
                <form class="form-horizontal" method="POST" action="">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="checkbox inline">
                                    <input type="checkbox" id="ban_char" name="ban_char" value="1" data-no-uniform="true">
                                </label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="checkbox inline">
                                    <input type="checkbox" id="search_acc" name="search_acc" value="1" data-no-uniform="true">
                                </label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="checkbox inline">
                                    <input type="checkbox" id="acc_details" name="acc_details" value="1" data-no-uniform="true">
                                </label>
                        ...
                        <div id="gm_command_list_igcn" style="display:none;">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="event_management" name="event_management" value="1" data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="fireworks" name="fireworks" value="2" data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="guild_commands" name="guild_commands" value="8" data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="chat_dc_move" name="chat_dc_move" value="4" data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="pk_set" name="pk_set" value="64" data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="gm_shop" name="gm_shop" value="1024" data-no-uniform="true">
                                    </label>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox inline">
                                        <input type="checkbox" id="invisible_to_monsters" name="invisible_to_monsters" value="2048" data-no-uniform="true">
                                    </label>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="input-xlarge datepicker" id="valid_until"
                                           name="valid_until" value="<?php echo date('m/d/Y', strtotime('+1 day')); ?>">
                                </div>
                            </div>
                        </div>
