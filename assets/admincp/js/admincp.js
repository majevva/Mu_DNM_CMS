$(document).ready(function(){
	...
	$('#apply_to_all_classes').on('click', function(){
		var value = $('#bonus_lvl_up_dw').val();
		if($.trim(value)){
			if($.isNumeric(value)){
				$('input[id^="bonus_lvl_up_"]').each(function(){
					$(this).val(value);
				});
				$("html, body").animate({ scrollTop: $('#bonus_lvl_up_ml').offset().top }, 1000);
			}
			else{
	...
	$("#downloads_sortable").find("tbody#downloads_sortable_content").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.saveDownloadsOrder(); }
    });
	...
	$("#donate_sortable").find("tbody#donate_sortable_content").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.savePaypalOrder(); }
    });
    ...
    $("#donate_sortable_checkout").find("tbody#donate_sortable_content_checkout").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.save2CheckOutOrder(); }
    });
	...
	$("#donate_sortable_pagseguro").find("tbody#donate_sortable_content_pagseguro").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.savePagSeguroOrder(); }
    });
    ...
    $("#donate_sortable_paycall").find("tbody#donate_sortable_paycall_content").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.savePaycallOrder(); }
    });
    ...
    $("#donate_sortable_cuenta_digital").find("tbody#donate_sortable_cuenta_digital_content").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.saveCuentaDigitalOrder(); }
    });
    ...
    $("#donate_sortable_interkassa").find("tbody#donate_sortable_interkassa_content").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.saveInterkassaOrder(); }
    });
	...
	$("#socket_sortable").find("tbody#socket_sortable_content").sortable({
		...
		opacity: 0.6, 
		cursor: 'move',
		update: function() { App.saveSocketOrder(); }
	});
    ...
    $("#serverlist_sortable").find("tbody#serverlist_sortable_content").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.saveServerOrder(); }
    });
	...
	$("#current_plugin_sortable").find("tbody#current_plugin_sortable_content").sortable({
        ...
        opacity: 0.6,
        cursor: 'move',
        update: function() { App.savePluginOrder(); }
    });
...
var App = {	
		...
		$.ajax({
            ...
            success: function(data){
                if(data.error){
					...
					$('#'+plugin+' #status_button').attr({'class':'btn btn-success'});
		...
		$.ajax({
            ...
            success: function(data){
                if(data.error){
					...
					$('#'+plugin+' #status_button').attr({'class':'btn btn-danger'});
		...
		$.ajax({
            ...
            success: function(data){
                ...
                if(data.success){
					...
					$('#'+plugin+' #status_icon').html('<span class="label label-success">Active</span>');
					$('#'+plugin+' #status_button').attr({'class':'btn btn-warning'});
					$('#'+plugin+' #status_button').html('<i class="icon-edit icon-white"></i> Disable');
					$('#'+plugin+' #status_button').attr('onclick', 'App.disablePlugin(\''+plugin+'\');');
			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.success){
						...
						$('#'+plugin+' #about_button').attr({'class':'btn btn-inverse'});
    ...
    loadDonationSettings: function(server, type){
        $.ajax({
                ...
                if(typeof data.error != 'undefined'){
                    ...
                    if(typeof data.info != 'undefined'){
                        ...
                        if(type == 'paymentwall'){
                            ...
                            $('#paymentwall_settings_form #height').val(data.info.height);
                            $('#paymentwall_settings_form #allowed_ip_list').tagsinput('removeAll');
                            $('#paymentwall_settings_form #allowed_ip_list').tagsinput('add', data.info.allowed_ip_list);
            ...
            error: function(error) {
                ...
                if(type == 'paymentwall'){
                    $('#paymentwall_settings_form #allowed_ip_list').tagsinput('removeAll');
                    $('#paymentwall_settings_form #allowed_ip_list').tagsinput('add', '66.220.10.2,66.220.10.3,174.36.92.186,174.36.96.66,174.36.92.187,174.36.92.192,174.37.14.28');
                }
                if(type == 'fortumo'){
                    $('#fortumo_settings_form #allowed_ip_list').tagsinput('removeAll');
            ...
            success: function( data ){
                if(data.error){
                    ...
                    if(status == 1){
                        ...
                        $('#vip_status_button_'+id).attr({'class':'btn btn-danger'});
                        ...
                        $('#vip_status_button_'+id).attr({'class':'btn btn-success'});
                ...
                success: function(data){
                    if(data.error){
                        ...
                        if(typeof data.info != 'undefined') {
                            ...
                            $("html, body").animate({ scrollTop: $('#edit_sql_table_settings').offset().top }, 2000);
                        }
                    }
                }
            });
            ...
            success: function( data ){
                if(data.error){
                    ...
                    if(status == 1){
                        ...
                        $('#status_button_2checkout_'+id).attr({'class':'btn btn-danger'});
                    }
                    else{
                        ...
                        $('#status_button_2checkout_'+id).attr({'class':'btn btn-success'});
                    }
                }
            }
        });
            ...
            success: function( data ){
                if(data.error){
                    ...
                    if(status == 1){
                        ...
                        $('#status_button_pagseguro_'+id).attr({'class':'btn btn-danger'});
                    }
                    else{
                        ...
                        $('#status_button_pagseguro_'+id).attr({'class':'btn btn-success'});
                    }
                }
            }
        });
            ...
            success: function( data ){
                if(data.error){
                    ...
                    if(status == 1){
                        ...
                        $('#status_button_interkassa_'+id).attr({'class':'btn btn-danger'});
                    }
                    else{
                        ...
                        $('#status_button_interkassa_'+id).attr({'class':'btn btn-success'});
                    }
                }
            }
        });
            ...
            success: function( data ){
                if(data.error){
                    ...
                    if(status == 1){
                        ...
                        $('#status_button_cuenta_digital_'+id).attr({'class':'btn btn-danger'});
                    }
                    else{
                        ...
                        $('#status_button_cuenta_digital_'+id).attr({'class':'btn btn-success'});
                    }
                }
            }
        });
            ...
            success: function( data ){
                if(data.error){
                    ...
                    if(status == 1){
                        ...
                        $('#status_button_paycall_'+id).attr({'class':'btn btn-danger'});
                    }
                    else{
                        ...
                        $('#status_button_paycall_'+id).attr({'class':'btn btn-success'});
                    }
                }
            }
        });
	...
	sentItem: function(){
		$.ajax({
			...
			data: $('#item_form').serialize() + '&' + $.param({'ajax' : 1}),
			beforeSend: function(){
...
function docReady(){
	...
	$('.thumbnails').on('click','.gallery-delete',function(e){
		...
		$.ajax({	
			type: 'POST',
			dataType: 'json',
			data: {id: that.parent().parent().parent().attr('id').split("-")[1]},
