...
<div id="content">
    <div id="box1">
        ...
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('Exchange'); ?> <?php echo $this->website->translate_credits($wcoin_config['credits_type'], $this->session->userdata(array('user' => 'server'))); ?> <?php echo _('To Wcoins'); ?></h2>
