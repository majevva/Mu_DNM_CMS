            ...
            <div class="entry">
                <div class="form">
                    <form method="post" action="<?php echo $this->config->base_url; ?>settings"
                        ...
                        <table>
                            <tr>
                                <td style="width:150px;"><?php echo _('Old Password'); ?>
                                    :
                                </td>
                                <td><input class="validate[required,minSize[3],maxSize[20]]" type="password"
                                           name="old_password" id="old_password" value=""/></td>
                            </tr>
                            <tr>
                                <td><?php echo _('New Password'); ?>:</td>
                                <td><input class="validate[required,minSize[3],maxSize[20]]" type="password"
                                           name="new_password" id="new_password" value=""/></td>
                            </tr>
                            <tr>
                                <td><?php echo _('Repeat New Password'); ?>
                                    :
                                </td>
                                <td><input class="validate[required,minSize[3],maxSize[20],equals[new_password]]"
