                            ...
                            <div id="item_options" style="display:none;">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="1" data-no-uniform="true">
                                                Increases Mana After monster +Mana/8
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="2" data-no-uniform="true">
                                                Increases Life After monster +Life/8
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="3" data-no-uniform="true">
                                                Increase attacking(wizardly)speed+7
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="4" data-no-uniform="true">
                                                Increase Damage +2%
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="5" data-no-uniform="true">
                                                Increase Damage +level/20
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="6" data-no-uniform="true">
                                ...
                                <div id="exe-2" style="display:none;">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="2" data-no-uniform="true"> Defense
                                                success rate +10%
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="3" data-no-uniform="true"> Reflect
                                                damage +5%
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="4" data-no-uniform="true"> Damage
                                                decrease +4%
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="5" data-no-uniform="true">
                                ...
                                <div id="exe-3" style="display:none;">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="1" data-no-uniform="true"> HP +115
                                                Increase
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="2" data-no-uniform="true"> MP +115
                                                Increase
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="3" data-no-uniform="true"> Ignore
                                                enemys defensive power by 3%
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="4" data-no-uniform="true"> Max AG
                                                +50 Increase
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="5" data-no-uniform="true">
                                ...
                                <div id="exe-4" style="display:none;">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="radio" name="fenrir" value="1" data-no-uniform="true"> Fenrir
                                                +Damage
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="radio" name="fenrir" value="2" data-no-uniform="true"> Fenrir
                                                +Defense
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="radio" name="fenrir" value="4" data-no-uniform="true"> Fenrir
                                                +Illusion
                                            </label><br/>
                                        </div>
                                    </div>
                                ...
                                <div id="exe-6" style="display:none;">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="1" data-no-uniform="true"> Ingore
                                                opponents defensive power by 5%
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="2" data-no-uniform="true"> Returns
                                ...
                                <div id="exe-7" style="display:none;">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="1" data-no-uniform="true"> Chance
                                                of Double Damage +4%
                                            </label><br/>
                                            <label class="checkbox inline">
                                                <input class="exe_check" type="checkbox" name="exe[]" value="2" data-no-uniform="true"> Chance
