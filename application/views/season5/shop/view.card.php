                    ...
                    $(document).ready(function () {
                        ...
                        $('#buy_items_credits').on('click', function (e) {
                            ...
                            if ($('#items_credits :checkbox:checked').length > 0) {
                                ...
                                App.notice(App.locale.error, 'error', App.locale.please_select_atleats_one_item);
                            }
                        });
                ...
                <div id="credits_items">
                    <?php
                        if($credits_items != false){
                                        ...
                                        foreach($credits_items as $key => $items){
                                            ...
                                            <tr id="item_<?php echo $items['id']; ?>" <?php echo $even; ?>>
                                                ...
                                                <td><input type="checkbox"
                                                           id="add_to_warehouse_1_<?php echo $items['id']; ?>"
                            ...
                            ?>
                            <div
                                class="i_note"><?php echo _('No items for %d in cart.', $this->config->config_entry('credits_' . $this->session->userdata(['user' => 'server']) . '|title_1')); ?></div>
                            <?php
                        }
                    ?>
                </div>
                ...
                <div id="gcredits_items">
                    <?php
                        if($gcredits_items != false){
                                    ...
                                    <?php
                                        ...
                                        foreach($gcredits_items as $key => $items){
                                            ...
                                            <tr id="item_<?php echo $items['id']; ?>" <?php echo $even; ?>>
                                                ...
                                                <td><input type="checkbox"
                                                           id="add_to_warehouse_2_<?php echo $items['id']; ?>"
                                                           name="add_to_warehouse[<?php echo $items['id']; ?>]"/></td>
                                                <td><a href=""
                            ...
                            ?>
                            <div
                                class="i_note"><?php echo _('No items for %d in cart.', $this->config->config_entry('credits_' . $this->session->userdata(['user' => 'server']) . '|title_2')); ?></div>
                            <?php
                        }
                    ?>
                </div>
