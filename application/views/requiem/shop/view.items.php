...
<div id="content">
    <div id="box1">
        <?php if ($this->config->config_entry('shop_' . $this->session->userdata(array('user' => 'server')) . '|discount') == 1 && strtotime($this->config->config_entry('shop_' . $this->session->userdata(array('user' => 'server')) . '|discount_time')) > time()): ?>
            <div class="discount_notice">
                <div class="ribbon-discount-green">
                    <div class="ribbon-green"><?php echo _('PROMO'); ?></div>
                </div>
                <div
                    class="content"><?php echo $this->config->config_entry('shop_' . $this->session->userdata(array('user' => 'server')) . '|discount_notice'); ?></div>
            </div>​
            <?php
        endif;
        ?>
        <div class="title1">
            <h1><?php echo _('Shop'); ?></h1>
        </div>
        <div id="content_center">
            <div class="box-style1" style="margin-bottom: 20px;">
                <h2 class="title"><?php echo _('View Items'); ?></h2>
                ...
                <div class="entry">
                    ...
                    if (isset($error)) {
                        ...
                        if (isset($items) && !empty($items)) {
                            ...
                            echo '<div style="clear:left;"></div><div class="w_note">' . _('Currently No Items In Webshop') . '</div>';
                        }
                        ?>
                        <?php
                        if (isset($pagination)) {
                            ...
                            success: function (data) {
                                if (data.error) {
                                    ...
                                    buy_dialog.dialog({
                                        width: 660,
                                        height: 'auto',
                                        title: "<?php echo _('Buy');?> " + item_name,
                                        dialogClass: 'fixed',
                                        show: {
                                            effect: "blind",
                                            duration: 500
