            ...
            <div class="entry">
                ...
                <div style="float:right;">
                    <a class="custom_button" href=""
                       id="show_filter"><?php echo __('Show Filter'); ?></a> <a class="custom_button"
                        ...
                        <div class="item_filter_content">
                            ...
                            <form method="post" action="">
                                ...
                                <input type="checkbox" name="luck"
                                    ...
                                    echo 'checked="checked"';
                                } ?>/> <?php echo __('Item Luck'); ?><br/> <input type="checkbox" name="skill"
                                                                                 value="1" <?php if(isset($_SESSION['filter']['skill'])){
                                    echo 'checked="checked"';
                                } ?>/> <?php echo __('Item Skill'); ?><br/> <input type="checkbox" name="ancient"
