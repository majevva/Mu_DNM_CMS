	...
	<div class="row-fluid">
        <div class="span12">
            <ul class="nav nav-pills">
                <li role="presentation" class="active"><a href="#player" aria-controls="player" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'player');">Players</a></li>
                <li role="presentation"><a href="#guild" aria-controls="guild" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'guild');">Guilds</a></li>
				<li role="presentation"><a href="#gens" aria-controls="gens" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'gens');">Gens</a></li>
				<li role="presentation"><a href="#voter" aria-controls="voter" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'voter');">Vote</a></li>
				<li role="presentation"><a href="#killer" aria-controls="killer" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'killer');">Killers</a></li>
				<li role="presentation"><a href="#online" aria-controls="online" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'online');">Online</a></li>
				<li role="presentation"><a href="#online_list" aria-controls="online_list" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'online_list');">Online List</a></li>
				<li role="presentation"><a href="#bc" aria-controls="bc" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'bc');">BC</a></li>
				<li role="presentation"><a href="#ds" aria-controls="ds" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'ds');">DS</a></li>
				<li role="presentation"><a href="#cc" aria-controls="cc" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'cc');">CC</a></li>
				<li role="presentation"><a href="#duels" aria-controls="duels" role="tab" data-toggle="tab" onclick="App.loadRankingsSettings('<?php echo $default_server;?>', 'duels');">Duels</a></li>
            </ul>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="active" name="active">
                                <option value="0" <?php if(isset($rankings_config[$default_server]['active']) && $rankings_config[$default_server]['active'] == 0){ echo 'selected="selected"';}?>>Inactive</option>
                                <option value="1" <?php if(isset($rankings_config[$default_server]['active']) && $rankings_config[$default_server]['active'] == 1){ echo 'selected="selected"';}?>>Active</option>
                            </select>
                            <p class="help-block">Rankings status</p>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="edit_rankings_status" id="edit_rankings_status">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="player_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="input-large" id="count_in_sidebar" name="count_in_sidebar" value=""/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="input-large" data-role="tagsinput" id="excluded_list" name="excluded_list" value=""/>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_player_settings" id="edit_player_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="guild">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="guild_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_guild_settings" id="edit_guild_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="gens">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="gens_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_gens_settings" id="edit_gens_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="voter">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="voter_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_voter_settings" id="edit_voter_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="killer">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="killer_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_killer_settings" id="edit_killer_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="online">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="online_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_online_settings" id="edit_online_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="online_list">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="online_list_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_online_list_settings" id="edit_online_list_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="bc">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="bc_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_bc_settings" id="edit_bc_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="ds">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="ds_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_ds_settings" id="edit_ds_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="cc">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="cc_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_cc_settings" id="edit_cc_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="duels">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="duels_settings_form">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_duels_settings" id="edit_duels_settings" value="Save changes">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
