                    ...
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="mail_mode" name="captcha_type">
                                    <option value="0" <?php if (isset($security_config['captcha_type']) && $security_config['captcha_type'] == 0) {echo 'selected="selected"';} ?>>None</option>
                                    <option value="1" <?php if (isset($security_config['captcha_type']) && $security_config['captcha_type'] == 1) {echo 'selected="selected"';} ?>>JS Captcha</option>
                                    <option value="2" <?php if (isset($security_config['captcha_type']) && $security_config['captcha_type'] == 2) {echo 'selected="selected"';} ?>>ReCaptcha</option>
                                    <option value="3" <?php if (isset($security_config['captcha_type']) && $security_config['captcha_type'] == 3) {echo 'selected="selected"';} ?>>ReCaptcha v2</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <p class="help-block">You can generate your recaptcha keys <a href="https://www.google.com/recaptcha/intro/index.html" target="_blank">here</a>.</p>
                            </div>
                        </div>
