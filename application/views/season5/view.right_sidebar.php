            ...
            <?php
                if($this->session->userdata(['user' => 'logged_in'])):
                    ...
                    <span style="float:right;"><a style="text-decoration:underline"
                                                  href="<?php echo $this->config->base_url; ?>logout"><?php echo _('Logout'); ?></a></span>
                    <?php
                else:
                    ?>
                    <div style="text-align:center;margin:0 auto;">
                        ...
                        <form id="login_form" method="post" action="<?php echo $this->config->base_url; ?>">
                            <input type="text" name="username" id="login_input" maxlength="10" class="input-main"
                                   style="width:182px;" placeholder="<?php echo _('Username'); ?>" value=""/>
                            <input type="password" name="password" id="password_input" maxlength="20" class="input-main"
                                   style="width:182px;" placeholder="<?php echo _('Password'); ?>" value=""/>

                            <div style="margin-left:15px">
                                <input type="submit" id="submit" value="<?php echo _('Login'); ?>" class="button-style"
                                       style="border:none;cursor:pointer "/>
                            </div>
                        </form>
                        <a href="<?php echo $this->config->base_url; ?>lost-password"><?php echo _('Lost Password'); ?>
                            ?</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
                            href="<?php echo $this->config->base_url; ?>registration"><?php echo _('Registration'); ?></a><br/>
                    </div>
                    <?php
                endif;
            ?>
                                ...
                                <ul class="style4">
                                    <?php
                                        foreach($load_rss as $key => $rss):
                                            ...
                                            ?>
                                            <li <?php echo $first; ?>><a
                                                    href="<?php echo $rss['link']; ?>"><?php echo $rss['title']; ?></a>
                                            </li>
                                            <?php
                                        endforeach;
                                    ?>
