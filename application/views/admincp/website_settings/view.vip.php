            ...
            <div class="box-content">
                <form class="form-horizontal" method="POST" action="" id="vip_settings_form">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="active" name="active">
                                <option value="0" <?php if(isset($vip_config['active']) && $vip_config['active'] == 0){echo 'selected="selected"';}?>>Inactive</option>
                                <option value="1" <?php if(isset($vip_config['active']) && $vip_config['active'] == 1){echo 'selected="selected"';}?>>Active</option>
                            </select>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="edit_vip_settings" id="edit_vip_settings">Save changes</button>
                    </div>
                </form>
            </div>
            <div class="box-header well">
                ...
                <table class="table" id="vip_sortable">
                    ...
                    foreach ($vip_packages AS $key => $package) {
                        ...
                        <tr id="<?php echo $package['id']; ?>">
                            ...
                            <td>
                                <?php if ($package['status'] == 1): ?>
                                    <a class="btn btn-danger" href="#" id="vip_status_button_<?php echo $package['id']; ?>"
                                       onclick="App.changeVipStatus(<?php echo $package['id']; ?>, 0);">
                                        <i class="icon-edit icon-white"></i>
                                        Disable
                                    </a>
                                <?php else: ?>
                                    <a class="btn btn-success" href="#" id="vip_status_button_<?php echo $package['id']; ?>"
                                       onclick="App.changeVipStatus(<?php echo $package['id']; ?>, 1);">
                                        <i class="icon-edit icon-white"></i>
                                        Enable
                                    </a>
                                <?php endif; ?>
                                <a class="btn btn-warning" href="#" onclick="App.deleteVipPackage(<?php echo $package['id']; ?>);">
                                    <i class="icon-edit icon-white"></i>
                                    Remove
                                </a>
