                                ...
                                echo '<ul id="paypal-options">
									<li>
										...
										if(isset($donation_config['type']) && $donation_config['type'] == 2){
											echo '<a href="'.$this->config->base_url.'donate/paypal-checkout/'.$packages['id'] . $this->csrf->writeTokenQueryString() . '" class="right custom_button" style="margin-top:8px;">' . __('Buy Now') . '</a>';
										}
										else{
