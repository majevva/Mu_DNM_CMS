                    ...
                    if($this->config->config_entry('news|storage') != 'facebook'){
                        foreach ($news as $key => $article):
                            ...
                            <div class="box-style1" style="margin-bottom:25px;">
                                <h2 class="title"><a
                                        href="<?php echo $article['url']; ?>"><?php echo $article['title']; ?></a></h2>

                                <div class="entry">
                                    <div
                                        style="width:600px;"><?php echo str_replace('&gt;', '>', str_replace('&lt;', '<', str_replace('Â', '&nbsp;', $article['content']))); ?></div>
                                    <div class="meta-bg">
                                        <div class="meta">
                                            <p class="tags"><?php echo _('Posted'); ?> <?php echo date('d / m / Y', $article['time']); ?></p>
