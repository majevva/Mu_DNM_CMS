    ...
    <div id="box1">
        ...
        <div class="box-style1" style="margin-bottom: 20px;">
            ...
            <div class="entry">
                ...
                <div style="float:right;">
                    <a class="btn-enter auth" href=""
                       id="show_filter"><?php echo _('Show Filter'); ?></a> <a class="btn-enter auth"
                        ...
                        <div class="item_filter_content">
                            <?php if(!empty($item_title_list)){ ?>
                                <form method="post" action="">
                                    ...
                                    <button class="btn-enter auth" type="submit" value="search_item"
                            ...
                            <form method="post" action="">
                                ...
                                <input type="checkbox" name="luck"
                                    ...
                                    echo 'checked="checked"';
                                } ?>/> <?php echo _('Item Luck'); ?><br/> <input type="checkbox" name="skill"
                                                                                 value="1" <?php if(isset($_SESSION['filter']['skill'])){
                                    echo 'checked="checked"';
                                } ?>/> <?php echo _('Item Skill'); ?><br/> <input type="checkbox" name="ancient"
                                ...
                                <div style="margin:10px;display:block;width: 90%;text-align:center;">
                                    <button class="btn-enter auth" type="submit" value="filter_items"
                                            name="filter_items"><?php echo _('Filter Items'); ?></button>
                                    <button class="btn-enter auth" type="submit" value="reset_filter"
