                            ...
                            <table width="100%">
                                ...
                                <?php if($this->config->values('vip_config', 'active') == 1): ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($this->session->userdata('vip')) ? $this->session->userdata(['vip' => 'title']) . ' (<a href="' . $this->config->base_url . 'shop/vip">' . _('Extend Now') . '</a>)' : _('None') . ' (<a href="' . $this->config->base_url . 'shop/vip">' . _('Buy Now') . '</a>)'; ?></td>
                                    </tr>
                                <?php endif; ?>
                            </table>
                        </div>
                        <div class="half">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="55%"><?php echo date('Y-m-d', strtotime($this->session->userdata(['user' => 'joined']))); ?></td>
                                </tr>
                                <tr>
                                    <td><img
                                            src="<?php echo $this->config->base_url; ?>assets/<?php echo $this->config->config_entry('main|template'); ?>/images/icons/shield.png"/>
                                    ...
                                    <td>
                                        <?php
                                            if(date('Y-m-d', strtotime($this->session->userdata(['user' => 'last_login']))) == date('Y-m-d', time())):
                                                echo _('Today') . ' ' . date('H:i', strtotime($this->session->userdata(['user' => 'last_login'])));
                                            else:
                                                echo date('Y-m-d', strtotime($this->session->userdata(['user' => 'last_login'])));
                                            endif;
                                        ?>
                                    </td>
                                </tr>
                                ...
                                <?php if($this->config->values('vip_config', 'active') == 1): ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($this->session->userdata('vip')) ? date('Y-m-d h:i', $this->session->userdata(['vip' => 'time'])) : _('Expired'); ?></td>
                                    </tr>
                                <?php endif; ?>
                            </table>
                        </div>
                ...
                <div class="entry">
                    <div id="character-info">
                        <table>
                            ...
                            <tr>
                                <td <?php if($this->config->config_entry('character_' . $this->session->userdata(['user' => 'server']) . '|allow_reset_stats') == 0){
                                    echo 'colspan="2"';
                                } ?>>
                                    <div>
                                        <ul>
