...
<div id="content">
    <div id="box1">
        <div class="title1">
            <h1><?php echo _('Reset Stats'); ?></h1>
        </div>
        <div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo _('Reassign your stats'); ?></h2>
                            ...
                            <table class="ranking-table">
                                ...
                                <?php
                                    foreach($char_list as $char){
                                        ...
                                        if(in_array($this->Mcharacter->char_info['Class'], [64, 65, 66]) && $this->Mcharacter->char_info['Leadership'] > 25){
