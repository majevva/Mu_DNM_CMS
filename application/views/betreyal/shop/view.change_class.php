                        ...
                        <form method="POST" action="" id="buy_class_form" name="buy_class_form">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="class_select" id="class_select">
                                            <option value="" disabled="disabled" selected="selected"><?php echo _('--SELECT--'); ?></option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <button type="submit" id="buy_class_button" class="button-style"><?php echo _('Submit'); ?></button>
                                    </td>
                                </tr>
                            </table>
                        </form>
