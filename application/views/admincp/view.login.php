                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <fieldset>
                        <div class="input-prepend" title="Username" data-rel="tooltip">
							...
							<input autofocus class="input-large span10" name="username" id="username" type="text" value="" placeholder="Username" required/>
                        </div>
                        <div class="clearfix"></div>
                        <div class="input-prepend" title="Password" data-rel="tooltip">
                            <span class="add-on"><i class="icon-lock"></i></span>
							<input class="input-large span10"  name="password" id="password" type="password" value="" placeholder="Password" required/>
                        </div>
                        <?php if(defined('PINCODE') && PINCODE != ''): ?>
						<div class="clearfix"></div>
                        <div class="input-prepend" title="<?php echo $first['placeholder'];?>" data-rel="tooltip">
                            <span class="add-on"><i class="icon-pencil"></i></span>
							<input class="input-large span10" name="first" id="first" type="text" value="" placeholder="<?php echo $first['placeholder'];?>" required/>
                        </div>
						<div class="clearfix"></div>
                        <div class="input-prepend" title="<?php echo $second['placeholder'];?>" data-rel="tooltip">
                            <span class="add-on"><i class="icon-pencil"></i></span>
							<input class="input-large span10" name="second" id="second" type="text" value="" placeholder="<?php echo $second['placeholder'];?>" required/>
                        </div>
						<div class="clearfix"></div>
                        <div class="input-prepend" title="<?php echo $third['placeholder'];?>" data-rel="tooltip">
                            <span class="add-on"><i class="icon-pencil"></i></span>
							<input class="input-large span10" name="third" id="third" type="text" value="" placeholder="<?php echo $third['placeholder'];?>" required/>
                        </div>
						<?php endif;?>
                        <div class="clearfix"></div>
