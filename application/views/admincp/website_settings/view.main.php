            ...
            <div class="box-content">
                <form class="form-horizontal" method="POST" action="">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="use_ajax_page_load">Ajax Page Load </label>

                            <div class="controls">
                                <select id="use_ajax_page_load" name="use_ajax_page_load">
                                    <option value="0" <?php if ($this->config->val[$args[0]]->use_ajax_page_load == 0) {
                                        echo 'selected="selected"';
                                    } ?>>No
                                    </option>
                                    <option value="1" <?php if ($this->config->val[$args[0]]->use_ajax_page_load == 1) {
                                        echo 'selected="selected"';
                                    } ?>>Yes
                                    </option>
                                </select>

                                <p class="help-block">Load website pages with ajax (<span style="color:red;">not supported on all templates</span>).
                                </p>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="cache_type" name="cache_type">
                                    ...
                                    <option
                                        value="memcached" <?php if ($this->config->val[$args[0]]->smtp_auth == 'memcached') {
                                        echo 'selected="selected"';
                                    } ?>>Memcached
                                    </option>
                                </select>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="show_debug_info">Debug Information </label>

                            <div class="controls">
                                <select id="show_debug_info" name="show_debug_info">
                                    <option value="0" <?php if ($this->config->val[$args[0]]->show_debug_info == 0) {
                                        echo 'selected="selected"';
                                    } ?>>No
                                    </option>
                                    <option value="1" <?php if ($this->config->val[$args[0]]->show_debug_info == 1) {
                                        echo 'selected="selected"';
                                    } ?>>Yes
                                    </option>
                                </select>

                                <p class="help-block">Show debug information in footer of website.</p>
                            </div>
                        </div>
