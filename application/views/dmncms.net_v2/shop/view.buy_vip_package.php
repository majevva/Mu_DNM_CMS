...
<div class="news_main">
	...
	<div class="content_rght_info m5">
		<div class="other">
            <h2 class="title">
				<?php if(isset($vip_data['package_title'])) { echo $vip_data['package_title'];}else{echo 'Undefined';} ?>			
			</h2>
			<div class="entry">
						...
						<table class="add_to_card" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>-<?php echo $this->website->zen_format($vip_data['reset_price_decrease']);?> <?php echo _('Zen'); ?></td>
								</tr>
								<?php endif;?>
								...
								<tr>
									...
									<td>-<?php echo $this->website->zen_format($vip_data['pk_clear_discount']);?> <?php echo _('Zen'); ?></td>
								</tr>
								<?php endif;?>
								...
								<tr>
									<td><?php echo _('Change Character Class Discount'); ?></td>
								...
								<?php endif;?>
								<tr>
									<td style="text-align:center;" colspan="2"><button type="submit" class="flatbtn-blu" id="buy_vip" name="buy_vip" value="buy_vip"><?php echo _('Buy Vip'); ?></button></td>
								</tr>
							</tbody>
						</table> 
					</form>
