        ...
        <div class="span12">
            <ul class="nav nav-pills">
                <li role="presentation" class="dropdown active">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Paypal<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#paypalsettings" aria-controls="paypalsettings" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'paypal');">Manage Settings</a></li>
                        <li><a href="#paypalpackages" aria-controls="paypalpackages" role="tab" data-toggle="tab">Manage Packages</a></li>
                    </ul>
                </li>
                <li role="presentation"><a href="#paymentwall" aria-controls="paymentwall" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'paymentwall');">Paymentwall</a></li>
                <li role="presentation"><a href="#fortumo" aria-controls="fortumo" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'fortumo');">Fortumo</a></li>
                <li role="presentation"><a href="#paygol" aria-controls="paygol" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'paygol');">PayGol</a></li>
                <li role="presentation" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">2CheckOut<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#2checkoutsettings" aria-controls="2checkoutsettings" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', '2checkout');">Manage Settings</a></li>
                        <li><a href="#2checkoutpackages" aria-controls="2checkoutpackages" role="tab" data-toggle="tab">Manage Packages</a></li>
                    </ul>
                </li>
                <li role="presentation" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">PagSeguro<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#pagsegurosettings" aria-controls="pagsegurosettings" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'pagseguro');">Manage Settings</a></li>
                        <li><a href="#pagseguropackages" aria-controls="pagseguropackages" role="tab" data-toggle="tab">Manage Packages</a></li>
                    </ul>
                </li>
                <li role="presentation" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">PayCall<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#paycallsettings" aria-controls="paycallsettings" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'paycall');">Manage Settings</a></li>
                        <li><a href="#paycallpackages" aria-controls="paycallpackages" role="tab" data-toggle="tab">Manage Packages</a></li>
                    </ul>
                </li>
                <li role="presentation"><a href="#superrewards" aria-controls="superrewards" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'superrewards');">SuperRewards</a></li>
                <li role="presentation" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Interkassa<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#interkassasettings" aria-controls="interkassasettings" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'interkassa');">Manage Settings</a></li>
                        <li><a href="#interkassapackages" aria-controls="interkassapackages" role="tab" data-toggle="tab">Manage Packages</a></li>
                    </ul>
                </li>
                <li role="presentation" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Cuenta Digital<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#cuenta_digitalsettings" aria-controls="cuenta_digitalsettings" role="tab" data-toggle="tab" onclick="App.loadDonationSettings('<?php echo $default_server;?>', 'cuenta_digital');">Manage Settings</a></li>
                        <li><a href="#cuenta_digitalpackages" aria-controls="cuenta_digitalpackages" role="tab" data-toggle="tab">Manage Packages</a></li>
                    </ul>
                </li>
            </ul>
    ...
    <div class="row-fluid">
        <div class="box span12">
            <div class="tab-content">
                        ...
                        <form class="form-horizontal" method="POST" action="" id="paypal_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after paypal donation.</p>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
									...
									<?php for ($i = .00; $i <= 100; $i += 0.01){?>
                                        <option value="<?php echo round($i, 3);?>"><?php echo round($i, 3);?>%</option>        
									<?php } ?>	
                                    </select>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
									<input type="text" class="span4 typeahead" id="paypal_fixed_fee" name="paypal_fixed_fee" value="" placeholder="0.00" />
                                    <p class="help-block">Paypal fixed fee.</p>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_paypal_settings" id="edit_paypal_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade" id="paypalpackages">
                    ...
                    <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable"
                                ...
                                <?php foreach ($packages_paypal as $pack): ?>
                                    <tr id="<?php echo $pack['id']; ?>">
                                        <td><input class="input-medium" type="text" id="pack_title_<?php echo $pack['id']; ?>"
                                        ...
                                        <td class="center">
                                            <?php if ($pack['status'] == 1): ?>
                                                <a class="btn btn-danger" href="#" id="status_button_<?php echo $pack['id']; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <td><input class="input-small" type="text" id="currency_new" placeholder="Currency" value=""/></td>
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="paymentwall_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="secret_key" name="secret_key" value=""/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="height" name="height" value=""/>
                                    <p class="help-block">PaymentWall widget height.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="allowed_ip_list">Allowed IP List</label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" data-role="tagsinput" id="allowed_ip_list" name="allowed_ip_list" value=""/>
                                    <p class="help-block">PaymentWall ip list. Do not edit if you don't know what are you doing.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="reward_type">Reward Type</label>
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after paymentwall donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_paymentwall_settings" id="edit_paymentwall_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="fortumo_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="service_id" name="service_id" value=""/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" data-role="tagsinput" id="allowed_ip_list" name="allowed_ip_list" value=""/>
                                    <p class="help-block">Fortumo ip list. Do not edit if you don't know what are you doing.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="reward_type">Reward Type</label>
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after fortumo donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_fortumo_settings" id="edit_fortumo_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form class="form-horizontal" method="POST" action="" id="paygol_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after paygol donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="currency_code" name="currency_code" value=""/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="service_price" name="service_price" value=""/>
                                    <p class="help-block">PayGol service price.</p>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_paygol_settings" id="edit_paygol_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="2checkout_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="seller_id" name="seller_id" value=""/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="private_key" name="private_key" value=""/>
                                    <p class="help-block">Can be found in your 2CheckOut account.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="private_secret_word" name="private_secret_word" value=""/>
                                    <p class="help-block">Can be found in your 2CheckOut account.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after 2checkout donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_2checkout_settings" id="edit_2checkout_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade" id="2checkoutpackages">
                    ...
                    <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable"
                                ...
                                <?php foreach ($packages_twocheckout as $pack): ?>
                                    <tr id="2checkout_<?php echo $pack['id']; ?>">
                                        <td><input class="input-medium" type="text" id="pack_title_2checkout_<?php echo $pack['id']; ?>"
                                                   value="<?php echo $pack['package']; ?>"/></td>
                                        <td class="center"><input class="input-small" type="text"
                                        ...
                                        <td class="center"><input class="input-small" type="text"
                                                                  ...
                                                                  value="<?php echo $pack['reward']; ?>"/></td>
                                        <td class="center">
                                            <select id="pack_server_2checkout_<?php echo $pack['id']; ?>" class="input-medium">
                                                <?php
                                                foreach ($server_list as $key => $server):
                                                    ?>
                                                    <option value="<?php echo $key; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            <tbody>
                            <tr>
                            <td><input class="input-medium" type="text" id="title_new_2checkout" placeholder="Title" value=""/></td>
                            <td><input class="input-small" type="text" id="price_new_2checkout" placeholder="Price" value=""/></td>
                            <td><input class="input-small" type="text" id="currency_new_2checkout" placeholder="Currency" value=""/></td>
                            <td><input class="input-small" type="text" id="reward_new_2checkout" placeholder="Reward" value=""/></td>
                            <td class="center">
                        ...
                        <form class="form-horizontal" method="POST" action="" id="pagseguro_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Email which you used when you registered PagSeguro account.</p>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $this->config->base_url; ?>payment/pagseguro
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after pagseguro donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_pagseguro_settings" id="edit_pagseguro_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade" id="pagseguropackages">
                    ...
                    <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable"
                                ...
                                <?php foreach ($packages_pagseguro as $pack): ?>
                                    <tr id="pagseguro_<?php echo $pack['id']; ?>">
                                        <td><input class="input-medium" type="text" id="pack_title_pagseguro_<?php echo $pack['id']; ?>"
                                                   value="<?php echo $pack['package']; ?>"/></td>
                                        <td class="center"><input class="input-small" type="text"
                                        ...
                                        <td class="center"><input class="input-small" type="text"
                                                                  ...
                                                                  value="<?php echo $pack['reward']; ?>"/></td>
                                        <td class="center">
                                            <select id="pack_server_pagseguro_<?php echo $pack['id']; ?>" class="input-medium">
                                                <?php
                                                foreach ($server_list as $key => $server):
                                                    ?>
                                                    <option value="<?php echo $key; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            <tbody>
                            <tr>
                            <td><input class="input-medium" type="text" id="title_new_pagseguro" placeholder="Title" value=""/></td>
                            <td><input class="input-small" type="text" id="price_new_pagseguro" placeholder="Price" value=""/></td>
                            <td><input class="input-small" type="text" id="currency_new_pagseguro" placeholder="Currency" value=""/></td>
                            <td><input class="input-small" type="text" id="reward_new_pagseguro" placeholder="Reward" value=""/></td>
                            <td class="center">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="paycall_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="business_code" name="business_code" value=""/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after paycall donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_paycall_settings" id="edit_paycall_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade" id="paycallpackages">
                    ...
                    <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable"
                                ...
                                <?php foreach ($packages_paycall as $pack): ?>
                                    <tr id="paycall_<?php echo $pack['id']; ?>">
                                        <td><input class="input-medium" type="text" id="pack_title_paycall_<?php echo $pack['id']; ?>"
                                                   value="<?php echo $pack['package']; ?>"/></td>
                                        <td class="center"><input class="input-small" type="text"
                                        ...
                                        <td class="center"><input class="input-small" type="text"
                                                                  ...
                                                                  value="<?php echo $pack['reward']; ?>"/></td>
                                        <td class="center">
                                            <select id="pack_server_paycall_<?php echo $pack['id']; ?>" class="input-medium">
                                                <?php
                                                foreach ($server_list as $key => $server):
                                                    ?>
                                                    <option value="<?php echo $key; ?>"
                                        ...
                                        <td class="center">
                                            <?php if ($pack['status'] == 1): ?>
                                                <a class="btn btn-danger" href="#" id="status_button_paycall_<?php echo $pack['id']; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            <tbody>
                            <tr>
                                <td><input class="input-medium" type="text" id="title_new_paycall" placeholder="Title" value=""/></td>
                                <td><input class="input-small" type="text" id="price_new_paycall" placeholder="Price" value=""/></td>
                                <td><input class="input-small" type="text" id="reward_new_paycall" placeholder="Reward" value=""/></td>
                                <td class="center">
                ...
                <div role="tabpanel" class="tab-pane fade" id="superrewards">
                    <div class="box-header well">
                        <h2><i class="icon-edit"></i> SuperRewards Settings</h2>
                    </div>
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="superrewards_settings_form">
                            <div class="control-group">
                                <label class="control-label" for="server">Settings Server </label>
                                <div class="controls">
                                    <select id="server" name="server">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="active">Superrewards Status </label>
                                <div class="controls">
                                    <select id="active" name="active">
                                        <option value="0">Inactive</option>
                                        <option value="1">Active</option>
                                    </select>
                                    <p class="help-block">Use superrewards donation method.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="app_hash">App Hash</label>

                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="app_hash" name="app_hash" value=""/>
                                    <p class="help-block">Superrewards app hash.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="postback_key">Postback Key</label>

                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="postback_key" name="postback_key" value=""/>
                                    <p class="help-block">Superrewards postback key.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="allowed_ip_list">Allowed IP List</label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" data-role="tagsinput" id="allowed_ip_list" name="allowed_ip_list" value=""/>
                                    <p class="help-block">SuperRewards ip list. Do not edit if you don't know what are you doing.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="reward_type">Reward Type</label>
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after superrewards donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="pingback">PostBack Url</label>
                                <div class="controls">
                                    <span id="pingback"><?php echo $this->config->base_url; ?>payment/superrewards</span>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_superrewards_settings" id="edit_superrewards_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form class="form-horizontal" method="POST" action="" id="interkassa_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after Interkassa donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_interkassa_settings" id="edit_interkassa_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade" id="interkassapackages">
                    ...
                    <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable"
                                ...
                                <?php foreach ($packages_interkassa as $pack): ?>
                                    <tr id="interkassa_<?php echo $pack['id']; ?>">
                                        <td><input class="input-medium" type="text" id="pack_title_interkassa_<?php echo $pack['id']; ?>"
                                                   value="<?php echo $pack['package']; ?>"/></td>
                                        <td class="center"><input class="input-small" type="text"
                                        ...
                                        <td class="center"><input class="input-small" type="text"
                                                                  ...
                                                                  value="<?php echo $pack['reward']; ?>"/></td>
                                        <td class="center">
                                            <select id="pack_server_interkassa_<?php echo $pack['id']; ?>" class="input-medium">
                                                <?php
                                                foreach ($server_list as $key => $server):
                                                    ?>
                                                    <option value="<?php echo $key; ?>"
                                        ...
                                        <td class="center">
                                            <?php if ($pack['status'] == 1): ?>
                                                <a class="btn btn-danger" href="#" id="status_button_interkassa_<?php echo $pack['id']; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            <tbody>
                            <tr>
                                <td><input class="input-medium" type="text" id="title_new_interkassa" placeholder="Title" value=""/></td>
                                <td><input class="input-small" type="text" id="price_new_interkassa" placeholder="Price" value=""/></td>
                                <td><input class="input-small" type="text" id="currency_new_interkassa" placeholder="Currency" value=""/></td>
                                <td><input class="input-small" type="text" id="reward_new_interkassa" placeholder="Reward" value=""/></td>
                                <td class="center">
                        ...
                        <form class="form-horizontal" method="POST" action="" id="cuenta_digital_settings_form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Cuenta Digital api type, Can be checked <a href="https://www.cuentadigital.com/area.php?name=Herramientas" target="_blank">here</a>.</p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="account_id">Account Id </label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="account_id" name="account_id" value=""/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="voucher_api_password" name="voucher_api_password" value=""/>
                                    <p class="help-block">Your ApiVoucher password. Can create <a href="https://www.cuentadigital.com/area.php?name=ApiVoucher" target="_blank">here</a>. </p>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="reward_type">Reward Type</label>
                                <div class="controls">
                                    ...
                                    <p class="help-block">Which donation points user will receive after CuentaDigital donation.</p>
                                    <p>For reward types check your credits settings <a
                                            href="<?php echo $this->config->base_url; ?>admincp/manage-settings/credits"
                                            target="_blank">here</a></p>
                                </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_cuenta_digital_settings" id="edit_cuenta_digital_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade" id="cuenta_digitalpackages">
                    ...
                    <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable"
                                ...
                                <?php foreach ($packages_cuenta_digital as $pack): ?>
                                    <tr id="cuenta_digital_<?php echo $pack['id']; ?>">
                                        <td><input class="input-medium" type="text" id="pack_title_cuenta_digital_<?php echo $pack['id']; ?>"
                                                   value="<?php echo $pack['package']; ?>"/></td>
                                        <td class="center"><input class="input-small" type="text"
                                        ...
                                        <td class="center"><input class="input-small" type="text"
                                                                  ...
                                                                  value="<?php echo $pack['reward']; ?>"/></td>
                                        <td class="center">
                                            <select id="pack_server_cuenta_digital_<?php echo $pack['id']; ?>" class="input-medium">
                                                <?php
                                                foreach ($server_list as $key => $server):
                                                    ?>
                                                    <option value="<?php echo $key; ?>"
                                        ...
                                        <td class="center">
                                            <?php if ($pack['status'] == 1): ?>
                                                <a class="btn btn-danger" href="#" id="status_button_cuenta_digital_<?php echo $pack['id']; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            <tbody>
                            <tr>
                                <td><input class="input-medium" type="text" id="title_new_cuenta_digital" placeholder="Title" value=""/></td>
                                <td><input class="input-small" type="text" id="price_new_cuenta_digital" placeholder="Price" value=""/></td>
                                <td><input class="input-small" type="text" id="currency_new_cuenta_digital" placeholder="Currency" value=""/></td>
                                <td><input class="input-small" type="text" id="reward_new_cuenta_digital" placeholder="Reward" value=""/></td>
                                <td class="center">
