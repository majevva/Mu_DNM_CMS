                ...
                <form class="form-horizontal" method="POST" action="" id="import_item_form">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <tr>
                            ...
                            <th><input type="checkbox" name="check_all" id="check_all" data-no-uniform="true"/> Check All</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php 
						...
						?>
                            <tr>
                                <td><?php echo $item[$key]['name']; ?></td>
                                <td><?php echo $category; ?></td>
                                <td><input type="text" name="price[<?php echo $item[$key]['id']; ?>]" value="0"/></td>
                                <td>
                                    <input type="checkbox" name="import[<?php echo $item[$key]['id']; ?>]" data-no-uniform="true"/>
                                    <input type="hidden" name="name[<?php echo $item[$key]['id']; ?>]"
                                           value="<?php echo $item[$key]['name']; ?>"/>
                                    <input type="hidden" name="slot[<?php echo $item[$key]['id']; ?>]"
                                           value="<?php echo $item[$key]['slot']; ?>"/>
                                </td>
                            </tr>
                        <?php 
							endforeach; 
