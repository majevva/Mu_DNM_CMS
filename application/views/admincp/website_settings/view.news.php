                    ...
                    <fieldset>
                        ...
                        <div id="ipb_settings" style="display:none;">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Invision Power Board Forum Ids. Form Where To Load News. Seperated
                                        By Comma</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="fb_settings" style="display:none;">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="form-control span6" id="fb_script" name="fb_script" rows="8"><?php echo $this->config->val[$args[0]]->fb_script; ?></textarea>
                                    <p class="help-block">Facebook page plugin script</p>
                                    <p><a href="https://developers.facebook.com/docs/plugins/page-plugin" target="_blank">https://developers.facebook.com/docs/plugins/page-plugin</a></p>
                                </div>
                            </div>
                        </div>
